...
- Dark mode has been permanently removed. The app forces light theme via `forcedTheme="light"` in ThemeProvider. The light theme uses a soft gray-blue palette (not pure white) for comfortable viewing. ThemeToggle renders null.
