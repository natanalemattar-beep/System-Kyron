  ...
  return (
    <div className="bg-card/50 backdrop-blur-sm rounded-lg border p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-background rounded-lg p-4">
          ...
          <ResponsiveContainer width="100%" height={250}>
            <AreaChart data={chartData}>
              ...
              />
              <Area type="monotone" dataKey="riesgo" stackId="1" stroke="#ef4444" fill="#fee2e2" fillOpacity={0.2}/>
              <Area type="monotone" dataKey="optimizacion" stackId="1" stroke="#10b981" fill="#d1fae5" fillOpacity={0.2}/>
            </AreaChart>
          </ResponsiveContainer>
        </div>
        ...
        {/* Impacto Financiero */}
        <div>
          <h3 className="font-semibold mb-4">Impacto Financiero Proyectado</h3>
          <div className="bg-blue-900/50 p-4 rounded-lg border border-blue-800 text-center mb-4">
            <div className="text-3xl font-bold text-blue-400">
              {formatCurrency(totalFinancialImpact)}
            </div>
            <div className="text-sm text-blue-300">Impacto Total Anual</div>
          </div>
