  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Certificación Matemática de Cero Riesgo</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <h3 className="font-semibold text-gray-900 mb-4">Teoremas Matemáticos Comprobados</h3>
          <div className="space-y-4">
            {proofs.map((proof) => (
              <div key={proof.id} className="border border-yellow-200 bg-yellow-50 rounded-lg p-4">
                <h4 className="font-semibold text-yellow-900">{proof.theorem}</h4>
                <p className="text-sm text-yellow-700 mt-1">{proof.description}</p>
        ...
        <div>
          <h3 className="font-semibold text-gray-900 mb-4">Certificaciones Internacionales</h3>
          <div className="space-y-4">
             <div className="border border-blue-200 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900">ISO 9001-ZR</h4>
                <p className="text-sm text-gray-600">Calidad de Cero Riesgo</p>
            </div>
             <div className="border border-purple-200 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900">Quantum Safe Certified</h4>
                <p className="text-sm text-gray-600">Resistente a Computación Cuántica</p>
            </div>
             <div className="border border-green-200 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900">Blockchain Immutable</h4>
                <p className="text-sm text-gray-600">Inmutabilidad Certificada</p>
            </div>
