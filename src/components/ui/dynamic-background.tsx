 ...
 * Reducción de complejidad en gradientes y animaciones fluidas.
 */
export function DynamicBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-50 h-full w-full overflow-hidden bg-background">
        ...
        {/* Rejilla HUD Adaptativa - Optimizada con CSS puro para evitar re-paints costosos */}
        <div className="absolute inset-0 -z-10 h-full w-full opacity-[0.1] dark:opacity-15 hud-grid" />

        {/* Logo de Fondo - Animación simplificada para CPU */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[200px] md:max-w-[280px] aspect-square opacity-[0.01] dark:opacity-[0.03] pointer-events-none p-8">
            <motion.div
              animate={{ 
                rotate: 360,
              }}
        ...
        {/* Resplandores dinámicos suaves - Opacidad reducida para mejor mezcla */}
        <motion.div 
            animate={{ 
                x: [0, 20, 0],
