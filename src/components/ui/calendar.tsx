  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        vhidden: "sr-only",
        dropdown_month: "[&>select]:h-8 [&>select]:px-2 [&>select]:rounded-lg [&>select]:border [&>select]:border-input [&>select]:bg-background [&>select]:text-sm [&>select]:font-medium [&>select]:appearance-none [&>select]:cursor-pointer [&>select]:pr-6",
        dropdown_year: "[&>select]:h-8 [&>select]:px-2 [&>select]:rounded-lg [&>select]:border [&>select]:border-input [&>select]:bg-background [&>select]:text-sm [&>select]:font-medium [&>select]:appearance-none [&>select]:cursor-pointer [&>select]:pr-6",
        dropdown: "relative",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-8 w-8 bg-transparent p-0 opacity-60 hover:opacity-100 rounded-lg"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-lg hover:rounded-lg"
        ),
