...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[12rem] overflow-hidden rounded-2xl border bg-popover/90 backdrop-blur-xl p-2 text-popover-foreground shadow-2xl",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-3 py-2 text-xs font-black uppercase tracking-widest text-muted-foreground/70",
      inset && "pl-8",
      className
    )}
    {...props}
