...
>(({ className, ...props }, ref) => {
  ...
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-transparent transition-all duration-300 ease-in-out overflow-hidden",
        "md:ml-[var(--sidebar-width)]",
        "group-data-[[data-state=collapsed]]/sidebar-wrapper:md:ml-[var(--sidebar-width-icon)]",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto p-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:overflow-visible",
        className
      )}
      {...props}
    />
