...
const SIDEBAR_WIDTH_ICON = "3.5rem" // Increased width for better logo visibility
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[state=collapsed]:peer-data-[collapsible=icon]:pl-[calc(var(--sidebar-width-icon)_+0rem)]",
        "peer-data-[variant=sidebar]:md:peer-data-[state=collapsed]:peer-data-[collapsible=icon]:pl-[var(--sidebar-width-icon)]",
