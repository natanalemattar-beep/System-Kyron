...
export function AppSidebar() {
  ...
  return (
    <Sidebar>
      ...
      <SidebarContent className="p-0 bg-card/80 backdrop-blur-sm">
      ...
      <SidebarFooter className="p-2 bg-card/80 backdrop-blur-sm">
...
function AppSidebarNatural() {
  ...
  return (
    <Sidebar>
      ...
      <SidebarContent className="p-2 bg-card/80 backdrop-blur-sm">
        <SidebarGroup>
