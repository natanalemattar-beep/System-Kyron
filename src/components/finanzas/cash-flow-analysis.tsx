                ...
                <ChartContainer config={chartConfig} className="w-full h-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={cashFlowData}>
                            ...
                            <ChartTooltip content={<ChartTooltipContent formatter={(value) => formatCurrency(value as number, 'Bs.')}/>} cursor={{ fill: 'hsl(var(--accent))', opacity: 0.5 }}/>
                            <Legend />
                            <Bar dataKey="ingresos" name="Ingresos" fill="var(--color-ingresos)" radius={[4, 4, 0, 0]} />
                            <Bar dataKey="egresos" name="Egresos" fill="var(--color-egresos)" radius={[4, 4, 0, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                </ChartContainer>
            </CardContent>
