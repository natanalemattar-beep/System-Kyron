    ...
    <Card className="glass-card border-none flex flex-col h-full">
      <CardHeader className="p-10 border-b border-white/5">
        <div className="flex items-center justify-between">
            <CardTitle className="text-[11px] font-semibold uppercase tracking-wider text-primary">Operaciones en Vivo</CardTitle>
              ...
              <DialogTrigger asChild>
                <li className="flex items-start gap-6 p-6 rounded-3xl bg-white/[0.02] border border-white/5 cursor-pointer hover:bg-white/[0.05] hover:border-primary/20 transition-all duration-300 group">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-[11px] font-semibold uppercase tracking-widest text-white/20">{activity.time}</p>
                  </div>
                </li>
              </DialogTrigger>
              <DialogContent className="rounded-[2.5rem] border-white/10 bg-black/90 backdrop-blur-3xl">
                  <DialogHeader>
                      <DialogTitle className="text-2xl font-semibold uppercase italic tracking-tight">Detalle Operativo</DialogTitle>
                  ...
                  <div className="py-10 space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-[10px] font-semibold uppercase tracking-widest">
                  ...
                  <DialogFooter>
                      <DialogTrigger asChild>
                        <Button className="w-full h-12 rounded-xl font-semibold uppercase text-[10px] tracking-widest">Cerrar Expediente</Button>
                      </DialogTrigger>
                  </DialogFooter>
              </DialogContent>
            </Dialog>
