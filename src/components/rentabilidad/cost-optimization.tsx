...
export const CostOptimization = () => {
  ...
  const getOptimizationColor = (potential: number) => {
    if (potential >= 20) return 'text-red-600 dark:text-red-400';
    if (potential >= 10) return 'text-yellow-600 dark:text-yellow-400';
  ...
  return (
    <div className="bg-white dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Optimizador de Costos</h2>
      ...
      {analysis && (
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-blue-50 dark:bg-blue-900/50 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-300">Potencial Ahorro</div>
          </div>
          <div className="bg-green-50 dark:bg-green-900/50 p-4 rounded-lg border border-green-200 dark:border-green-800">
            ...
            <div className="text-sm text-green-800 dark:text-green-300">Varianza Total</div>
          </div>
          <div className="bg-purple-50 dark:bg-purple-900/50 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
            ...
            <div className="text-sm text-purple-800 dark:text-purple-300">Estructura Fija</div>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Análisis por Categoría</h3>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs ${
                        category.trend === 'up' ? 'bg-red-100 dark:bg-red-900/50 text-red-800 dark:text-red-300' :
                        category.trend === 'down' ? 'bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300' :
        ...
        <div className="space-y-6">
          {analysis && (
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Estructura de Costos</h3>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/50 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            <h3 className="font-semibold text-yellow-900 dark:text-yellow-200 mb-3">🔄 Estrategias de Optimización</h3>
          ...
          <div className="bg-green-50 dark:bg-green-900/50 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <h3 className="font-semibold text-green-900 dark:text-green-200 mb-3">📈 Proyección de Impacto</h3>
