                    ...
                    <div className="flex items-center justify-start shrink-0">
                        <Link href="/" className="flex items-center gap-2.5 sm:gap-3.5 group shrink-0">
                            ...
                            <div className="flex flex-col">
                                <span className={cn(
                                    "text-xs sm:text-[13px] font-bold tracking-[0.25em] sm:tracking-wide uppercase italic leading-none transition-colors duration-500",
                    ...
                    <nav className="hidden lg:flex items-center justify-center gap-7 xl:gap-10 flex-1">
                        {navItems.map((item) => (
                            <Link 
                                ...
                                className={cn(
                                    "text-[11px] font-semibold uppercase tracking-wide transition-all duration-300 relative group py-1",
                                    isScrolled
                    ...
                    <div className="flex items-center justify-end gap-2.5 sm:gap-3 shrink-0">
                        ...
                        <div className="hidden sm:flex items-center gap-2">
                            <Button variant="ghost" asChild data-guide="register" className={cn(
                                "rounded-xl h-9 px-5 text-[11px] font-semibold uppercase tracking-[0.15em] border-2 transition-all duration-300 relative overflow-hidden group",
                                isScrolled
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button data-guide="access" className="rounded-xl h-9 px-5 text-[11px] font-semibold uppercase tracking-[0.15em] border-0 text-white shadow-lg shadow-cyan-500/25 hover:shadow-xl hover:shadow-cyan-500/40 hover:scale-[1.04] active:scale-[0.97] transition-all duration-300 relative overflow-hidden group bg-gradient-to-r from-[#06b6d4] via-[#0ea5e9] via-[#3b82f6] to-[#8b5cf6] bg-[length:300%_100%] animate-gradient-flow">
                                ...
                                <DropdownMenuContent align="end" className="w-[min(520px,calc(100vw-2rem))] p-0 rounded-2xl border-border/30 bg-card/98 backdrop-blur-3xl shadow-lg shadow-black/[0.08] overflow-hidden">
                                                ...
                                                <DropdownMenuItem key={option.href} asChild className="rounded-xl p-0 cursor-pointer focus:bg-transparent data-[highlighted]:bg-transparent">
                                                    <Link href={option.href as any} className="flex items-center gap-3 p-3 rounded-xl border border-border/20 bg-card/40 hover:bg-card hover:border-border/40 hover:shadow-sm hover:-translate-y-0.5 transition-all duration-200 group">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <p className="text-[11px] text-muted-foreground/70 line-clamp-1 mt-0.5 leading-snug">{option.description}</p>
                                                        </div>
                        ...
                        <Sheet>
                            ...
                            <SheetContent side="left" className="w-[85vw] max-w-[340px] p-0 bg-background border-r border-border/30 flex flex-col">
                                <SheetHeader className="p-5 border-b border-border/20 bg-muted/5 flex flex-row items-center gap-3.5 shrink-0 space-y-0">
                                    ...
                                    <div className="flex flex-col">
                                        <SheetTitle className="text-[13px] font-bold tracking-tight text-foreground leading-none">{t('mobile_portal')}</SheetTitle>
                                        <span className="text-[7px] font-bold uppercase tracking-wide mt-1 text-muted-foreground/70">
                                            {tHero('slogan')}
                                        </span>
                                    </div>
                                </SheetHeader>
                                ...
                                <div className="p-4 border-t border-border/20 space-y-3 bg-muted/5 shrink-0">
                                    ...
                                    <Button asChild className="w-full h-12 rounded-2xl font-semibold text-xs uppercase tracking-widest border-0 text-white shadow-lg shadow-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 relative overflow-hidden group bg-gradient-to-r from-[#06b6d4] via-[#0ea5e9] via-[#3b82f6] to-[#8b5cf6] bg-[length:300%_100%] animate-gradient-flow">
