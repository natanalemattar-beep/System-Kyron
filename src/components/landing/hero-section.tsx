        ...
        <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
            <div className="absolute inset-0 -z-10">
                <Image
                    ...
                    priority
                />
                <div className="absolute inset-0 bg-gradient-to-b from-[#020810]/85 via-[#020810]/65 to-[#020810]" />
                <div className="absolute inset-0 bg-gradient-to-r from-[#020810]/60 via-transparent to-[#020810]/40" />
            </div>

            <div className="absolute inset-0 pointer-events-none -z-[5] overflow-hidden">
                <div className="absolute top-1/4 -left-20 w-[400px] h-[400px] rounded-full bg-primary/10 blur-[100px]" />
                <div className="absolute bottom-1/4 -right-20 w-[350px] h-[350px] rounded-full bg-cyan-500/8 blur-[80px]" />
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 space-y-7 text-center lg:text-left">
                        ...
                        <motion.p
                            ...
                            className="text-base md:text-lg text-white/60 max-w-lg mx-auto lg:ml-0 font-medium leading-relaxed"
                        >
                            {t('subtitle')}
                        </motion.p>
                    ...
                    >
                        <div className="relative mx-auto max-w-[560px] lg:max-w-none">
                            <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/15 via-primary/15 to-emerald-500/15 rounded-[2rem] blur-2xl opacity-50" />
