    ...
    return (
        <section id="inicio" className="relative pt-24 pb-12 md:pt-32 md:pb-20 overflow-hidden min-h-[85vh] flex items-center">
            ...
            <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
                ...
                <div className="absolute bottom-12 left-8 w-5 h-5 border-b-2 border-l-2 border-primary/15" />
                <div className="absolute bottom-12 right-8 w-5 h-5 border-b-2 border-r-2 border-primary/15" />
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-10 max-w-7xl relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-6 space-y-7 text-center lg:text-left">
                        <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-primary/15 bg-primary/5 backdrop-blur-sm mx-auto lg:ml-0 animate-border-glow">

                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
                                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-400" />
                            </span>
                            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-primary">Sistema Operativo • v2.8.2</span>
                        </div>
