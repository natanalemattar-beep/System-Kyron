...
export function IntegrationsStrip() {
    ...
    return (
        <section className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-br from-lime-50/40 via-green-50/30 to-emerald-50/40 dark:from-[hsl(224,28%,9%)] dark:via-[hsl(224,24%,8%)] dark:to-[hsl(224,28%,10%)]">
            <div className="absolute inset-0 -z-10 pointer-events-none">
                <div className="absolute top-[30%] right-[10%] w-[400px] h-[400px] rounded-full bg-lime-400/[0.06] dark:bg-lime-400/[0.03] blur-[100px]" />
                <div className="absolute bottom-[10%] left-[15%] w-[350px] h-[350px] rounded-full bg-emerald-400/[0.05] dark:bg-emerald-400/[0.02] blur-[90px]" />
            </div>
