        ...
        <section id="nosotros" className="relative overflow-hidden">
            <div className="relative py-20 md:py-28">
                ...
                <div className="container mx-auto px-4 md:px-10 max-w-7xl relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-[10px] font-black uppercase tracking-[0.35em] text-white/80 mx-auto">
                    ...
                    >
                        {[
                            ...
                            >
                                <Card className="relative overflow-hidden rounded-[2rem] bg-white/5 dark:bg-white/[0.03] backdrop-blur-xl border border-white/10 p-8 text-center group cursor-default hover:border-white/20 transition-all duration-500 shadow-2xl">
                    ...
                    >
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3 p-4 rounded-2xl bg-white/5 border border-white/8 backdrop-blur-sm">
                    ...
                    >
                        <Link href="/register" className="group inline-flex items-center gap-3 px-8 py-3.5 rounded-2xl border border-white/15 bg-white/5 backdrop-blur-sm text-white text-xs font-black uppercase tracking-widest hover:bg-white/10 hover:border-white/25 transition-all duration-500">
