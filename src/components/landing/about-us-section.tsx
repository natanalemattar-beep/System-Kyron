        ...
        <section id="nosotros" className="relative overflow-hidden">
            <div className="relative py-20 md:py-28">
                ...
                <div className="container mx-auto px-4 md:px-10 lg:px-12 max-w-[1440px] relative z-10">
                    ...
                    >
                        <Link href="/register" className="group inline-flex items-center gap-4 px-10 py-4 rounded-2xl glass-liquid-hud text-white text-[11px] font-black uppercase tracking-[0.2em] transition-all duration-500">
                            {t('join_cta')} <ArrowRight className="h-4 w-4 group-hover:translate-x-1.5 transition-transform text-cyan-400" />
                        </Link>
                    </motion.div>
                </div>
            </div>
