...
const guarantees = [
    { icon: Shield, label: "Datos Cifrados AES-256" },
                        ...
                        >
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-2">
                                {guarantees.map((g, i) => (
                                    <motion.div
                                        key={i}
                                        className="flex items-center gap-2.5 px-4 py-3 rounded-xl liquid-glass-subtle"
                                    ...
                                    >
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-wider text-foreground/70">{g.label}</span>
                                    </motion.div>
                                ))}
                            </div>
