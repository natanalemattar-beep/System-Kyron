...
export const mockInvoices: Invoice[] = [
    {
      id: 'INV-001',
      customer: 'Tech Solutions Venezuela, C.A.',
      customerEmail: 'facturacion@techsolutions.com.ve',
      date: '2026-02-20',
      dueDate: '2026-03-22',
      amount: 5000,
      status: 'Enviada',
    ...
    {
      id: 'INV-002',
      customer: 'Inversiones Epsilon, C.A.',
      customerEmail: 'cuentas@inversionesepsilon.com.ve',
      date: '2026-02-18',
      dueDate: '2026-03-20',
      amount: 12000,
      status: 'Pagada',
    ...
    {
      id: 'INV-003',
      customer: 'Marketing Digital Caracas, C.A.',
      customerEmail: 'contacto@mdcaracas.com.ve',
      date: '2026-01-25',
      dueDate: '2026-02-24',
      amount: 2500,
      status: 'Vencida',
     ...
     {
      id: 'INV-004',
      customer: 'Constructora Bolívar, C.A.',
      customerEmail: 'pagos@constructorabolivar.com.ve',
      date: '2026-02-22',
      dueDate: '2026-03-24',
      amount: 7500,
      status: 'Borrador',
     ...
     {
      id: 'INV-005',
      customer: 'Suministros Costa, C.A.',
      customerEmail: 'admin@suministroscosta.com.ve',
      date: '2026-02-15',
      dueDate: '2026-03-17',
      amount: 800,
      status: 'Enviada',
