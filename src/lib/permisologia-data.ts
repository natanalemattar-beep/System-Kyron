...
export const tiposPermiso: PermisoTipo[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  // GOBERNACIONES — PERMISOS ESTADALES
  // ═══════════════════════════════════════════════════════════════
  {
    id: 'GOB-SANIDAD',
  ...
  },
  {
    ...
    organismoId: 'GOB-MIRANDA',
    descripcion: 'Permiso estadal para la venta de bebidas alcohólicas al público (bares, restaurantes, licorerías).',
    vigencia: 12,
    requisitosInscripcion: ['Licencia municipal vigente', 'RIF vigente', 'Permiso de bomberos', 'Ubicación fuera de zona restringida (escuelas, hospitales)'],
    requisitosRenovacion: ['Pago anual del impuesto sobre alcohol', 'Inspección del establecimiento'],
    costoEstimado: '5-20 UT estadales',
    baseLegal: 'Ley de Impuesto sobre Alcohol y Especies Alcohólicas, Ordenanzas estadales',
  ...
  },
  {
    ...
    organismoId: 'GOB-MIRANDA',
    descripcion: 'Pago de timbres fiscales estadales requeridos para trámites ante gobernaciones (licencias, solvencias, certificaciones).',
    vigencia: null,
    requisitosInscripcion: ['Documento que requiera timbre estadal', 'Planilla de pago'],
    requisitosRenovacion: ['Pago por cada trámite'],
    costoEstimado: '0.5-5 UT estadales',
    baseLegal: 'Ley de Timbre Fiscal Estadal',
    aplica: ['todos'],
  },
];
