...
export const tiposPermiso: PermisoTipo[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    nombre: 'Formularios Oficiales del SENIAT',
    organismoId: 'SENIAT',
    descripcion: 'Compilación de formularios oficiales del SENIAT para trámites tributarios y aduaneros: Forma 30 (Declaración IVA), Forma 25 (Retenciones ISLR), Forma 99 (ISLR), Forma DPJ-26 (Declaración Definitiva Persona Jurídica), Forma DPN-25 (Declaración Definitiva Persona Natural), Forma 33 (Retenciones IVA), Planilla de Liquidación, Forma RIF-07 (Inscripción/Actualización RIF), y formularios de sucesiones, donaciones, y solicitudes varias. Descargables en formato PDF desde el portal.',
    vigencia: null,
    requisitosInscripcion: ['Acceso al portal seniat.gob.ve → Asistencia → Formularios', 'Identificar el formulario según el trámite requerido'],
    requisitosRenovacion: ['Verificar versiones actualizadas de formularios antes de usar'],
