...
import { Gavel, Eye, EyeOff, Building, ShoppingCart, Briefcase, Users, Megaphone, Cpu, User, Copy } from "lucide-react";
      ...
      <form>
        <CardContent className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <Input id="username" type="text" placeholder="legal.user" required defaultValue="legal.user"/>
          </div>
          ...
          <Button asChild type="submit" className="w-full h-11 text-base">
            <Link href="/escritorio-juridico">Acceder</Link>
          </Button>
