...
import { Briefcase, Eye, EyeOff, User, Building, ShoppingCart, Users, Megaphone } from "lucide-react";
      ...
      <main className="flex-1 flex items-center justify-center p-4 z-10">
        <Card className="w-full max-w-md mx-auto bg-card/60 backdrop-blur-xl border-primary/20 shadow-lg shadow-primary/10 animate-border-glow">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl tracking-wider">Acceso RR.HH.</CardTitle>
            <CardDescription>Inicia sesión con tu usuario de Recursos Humanos.</CardDescription>
          </CardHeader>
          <CardContent className="p-6 space-y-6">
            <div className="space-y-2">
              <Label>Usuario</Label>
              <Input type="text" placeholder="usuario.rrhh" className="bg-background/50"/>
            </div>
