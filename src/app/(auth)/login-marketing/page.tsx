...
import { Megaphone, Eye, EyeOff, Building, ShoppingCart, Briefcase, Users, Cpu, Gavel, User } from "lucide-react";
...
export default function LoginMarketingPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    router.push('/asesoria-publicidad');
  };
      ...
      <form onSubmit={handleLogin}>
        <CardContent className="p-6 space-y-6">
          <div className="space-y-2">
            <Label>Usuario</Label>
            <Input type="text" placeholder="usuario.marketing" required />
          </div>
