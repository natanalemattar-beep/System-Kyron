      ...
      <Card className="bg-white/[0.02] border-white/5 backdrop-blur-3xl rounded-[2.5rem] overflow-hidden shadow-2xl">
        <CardContent className="p-10 md:p-16 prose prose-sm dark:prose-invert max-w-none text-justify space-y-8 text-white/70">
            <section>
                ...
                <p>
                    Bienvenido a System Kyron. Nos comprometemos a proteger la integridad de su información bajo estándares de cifrado de grado corporativo. Esta política detalla la captura y el sellado inmutable de sus activos digitales.
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    ...
                    <a href="mailto:infosystemkyron@gmail.com" className="text-primary font-black underline decoration-primary/30">infosystemkyron@gmail.com</a>
                </p>
            </section>
        </CardContent>
      </Card>
