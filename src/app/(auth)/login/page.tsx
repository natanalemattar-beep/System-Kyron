            ...
            >
                <header className="flex flex-col items-center text-center mb-16">
                    <motion.div variants={itemVariants} className="self-start mb-8">
                        <Button variant="ghost" asChild className="group rounded-xl">
                            <Link href="/"><ChevronLeft className="mr-2 h-4 w-4 transition-transform group-hover:-translate-x-1"/> Volver al ecosistema</Link>
                        </Button>
                    </motion.div>
                    
                    <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/5 border border-primary/10 text-primary text-[10px] font-black tracking-[0.2em] uppercase mb-6">
                        <ShieldCheck className="h-3.5 w-3.5" /> Acceso Seguro Encriptado
                    </motion.div>

                    <motion.h1 variants={itemVariants} className="text-4xl md:text-7xl font-extrabold tracking-tighter mb-6 text-balance leading-none">
                ...
                <div className="grid gap-16">
                    ...
                    <motion.section variants={itemVariants}>
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <h2 className="text-xs font-black uppercase tracking-[0.3em] opacity-60 flex items-center gap-3">
                        ...
                        {personalOption && (
                            <Card className="group relative overflow-hidden bg-card/40 backdrop-blur-xl border-2 hover:border-primary/40 transition-all duration-500 shadow-2xl rounded-[2.5rem]">
                                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                <Link href={personalOption.href} className="relative z-10 flex flex-col md:flex-row items-center p-10 md:p-14 gap-10">
                                    <div className="p-8 bg-primary/5 rounded-[2rem] group-hover:scale-105 group-hover:bg-primary/10 transition-all duration-500 border border-primary/5">
                                        <personalOption.icon className="h-16 w-16 text-primary" />
                                    </div>
                                    <div className="flex-1 text-center md:text-left space-y-3">
                                        <h3 className="text-3xl md:text-4xl font-black flex items-center justify-center md:justify-start gap-3 tracking-tighter">
                                    ...
                                    <Button size="lg" className="h-16 px-12 rounded-2xl group-hover:translate-x-2 transition-all duration-500 text-lg font-black shadow-xl btn-3d-primary">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {enterpriseOptions.map((option) => (
                                <motion.div
                                    ...
                                    whileHover={{ y: -8 }}
                                >
                                    <Card className="h-full group hover:border-primary/40 transition-all duration-500 bg-card/40 backdrop-blur-lg flex flex-col border-border/50 shadow-lg hover:shadow-primary/5 rounded-[2rem] overflow-hidden">
                                        <Link href={option.href} className="flex flex-col h-full">
                                            <CardHeader className="flex-row items-center gap-5 p-8 pb-6">
                                                ...
                                                <CardTitle className="text-xl font-bold group-hover:text-primary transition-colors tracking-tight">{option.label}</CardTitle>
                                            </CardHeader>
                                            ...
                                            <div className="p-8 pt-0 mt-auto border-t border-border/10">
                                                <span className="text-[10px] font-black uppercase tracking-[0.25em] text-primary/40 group-hover:text-primary inline-flex items-center group-hover:gap-3 transition-all duration-500">
