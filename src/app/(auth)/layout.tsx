...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 text-foreground relative">
      <header className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-sm border-b border-slate-800">
       ...
       <div className="bg-yellow-900/20 border-y border-yellow-800/50 py-2">
