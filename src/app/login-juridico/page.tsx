  ...
  return (
    <div className="flex flex-col min-h-screen text-foreground relative overflow-hidden bg-slate-900">
      <div className="absolute inset-0 z-0 opacity-50">
        ...
        <div className="absolute inset-0 bg-gradient-to-bl from-sky-900 via-transparent to-transparent animate-gradient-animation" style={{ animationDuration: '25s', animationDelay: '5s' }}></div>
      </div>
