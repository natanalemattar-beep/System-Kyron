            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="mt-6 text-lg md:text-xl text-balance text-white/80 max-w-3xl mx-auto"  style={{textShadow: '0 2px 8px rgba(0,0,0,0.7)'}}>
                        Accede a tus líneas de compra de forma inmediata. Aprobamos tus líneas de compra en 3 minutos. Descarga nuestra app, regístrate y obtenla.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <p className="text-muted-foreground text-lg mt-4">
                            Cada kilo de material reciclado se convierte en un plato de comida, una medicina o un recurso para quienes más lo necesitan. Con tus pagos a tiempo y adelantos de cuotas acumulas puntos para aumentar tus líneas de compra y acceder a nuevos beneficios.
                        </p>
        ...
        <section className="py-20 md:py-28 text-center">
             <div className="container mx-auto px-4 md:px-6">
                ...
                <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                    Tu empresa también puede ser parte del cambio. Contáctanos para conocer cómo puedes colaborar con nuestro programa de reciclaje corporativo. Te enviaremos recordatorios para que nunca te saltes una cuota.
                </p>
