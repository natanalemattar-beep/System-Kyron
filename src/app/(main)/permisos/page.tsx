...
const initialPermisos = [
    ...
    { id: "PERM-PET-002", tipo: "Transporte Acuático de Hidrocarburos", emisor: "MINPET / INEA", fechaEmision: "2024-02-15", fechaVencimiento: "2025-02-15", estado: "Vigente", requisitos: ["Matrícula de la embarcación", "Certificado de seguridad"] },
    ...
    { id: "PERM-MIN-001", tipo: "Desarrollo Minero Ecológico", emisor: "Min. Desarrollo Minero", fechaEmision: "2024-03-10", fechaVencimiento: "2026-03-10", estado: "Vigente", requisitos: [] },

    // --- Ministerios - Comercio e Industria ---
    { id: "PERM-COM-001", tipo: "Licencia de Importación", emisor: "Min. Comercio / SENIAT", fechaEmision: "2024-07-01", fechaVencimiento: "2024-12-31", estado: "Vigente", requisitos: ["Factura Comercial", "Documento de Transporte"] },
    { id: "PERM-COM-002", tipo: "Licencia de Exportación", emisor: "Min. Comercio / BANCOEX", fechaEmision: "2024-06-15", fechaVencimiento: "2024-12-15", estado: "Vigente", requisitos: ["Certificado de Origen"] },
    ...
    { id: "PERM-CONS-001", tipo: "Permiso de Construcción de Obra Civil", emisor: "Min. Obras Públicas / Alcaldía", fechaEmision: "2024-02-01", fechaVencimiento: "2026-02-01", estado: "Vigente", requisitos: [] },
    { id: "PERM-CONS-002", tipo: "Permiso de Desmantelamiento de Instalaciones", emisor: "Min. Obras Públicas / MINEC", fechaEmision: "2024-03-18", fechaVencimiento: "2024-09-18", estado: "Por Vencer", requisitos: [] },
    ...
    { id: "PERM-CUL-001", tipo: "Asignación de ISBN", emisor: "CENAL (Min. Cultura)", fechaEmision: "2024-04-20", fechaVencimiento: "N/A", estado: "Vigente", requisitos: [] },
    ...
    { id: "PERM-NAC-006", tipo: "Inscripción en el RESQUIMC", emisor: "ONA (Min. Interior)", fechaEmision: "2024-05-15", fechaVencimiento: "2025-05-15", estado: "Vigente", requisitos: [] },
