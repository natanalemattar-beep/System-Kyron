...
import { Cpu, Server, Shield, BrainCircuit, Link as LinkIcon, Bot, ArrowRight, Table as TableIcon, FileText } from "lucide-react";
        ...
        <CardContent>
            <Accordion type="multiple" defaultValue={["item-ia", "item-blockchain"]} className="w-full">
                ...
                <AccordionItem value="item-blockchain">
                    ...
                    <AccordionContent>
                        <p className="my-4">El uso de Blockchain (Contabilidad de Triple Entrada) ofrece una capa de inmutabilidad y transparencia imposible con sistemas tradicionales.</p>
                        <ul className="list-disc pl-5 space-y-2">
