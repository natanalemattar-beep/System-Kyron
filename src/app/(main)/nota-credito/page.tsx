...
import { FilePlus, Download, Printer, ShieldCheck } from "lucide-react";
...
const notaCredito = {
    numero: "NC-0000456",
    numeroControl: "2024-NC-0000456",
    fechaEmision: new Date(),
    facturaAfectada: "00001230",
    empresa: {
    ...
    items: [
        { id: 1, descripcion: "Devolución de Licencia Anual - Plan Emprendedor", cantidad: 1, precio: 360 },
        { id: 2, descripcion: "Descuento por pronto pago", cantidad: 1, precio: 50 },
    ],
    motivo: "Devolución de producto y ajuste por descuento no aplicado en factura original.",
};

const subtotal = notaCredito.items.reduce((acc, item) => acc + (item.cantidad * item.price), 0);
      ...
      <header className="mb-8 flex items-center justify-between">
        <div>
            ...
            <p className="text-muted-foreground mt-2">
              Diseño de nota de crédito para anular o corregir facturas, adaptada a la normativa fiscal.
            </p>
        </div>
