        ...
        <header className="mb-8 flex items-center justify-between">
            <div>
                <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
                    ...
                    Manual de Usuario de System C.S.M
                </h1>
        ...
        <div className="space-y-8">
            <Card className="bg-card/50 backdrop-blur-sm">
                <CardHeader>
                    ...
                    <CardDescription>Bienvenido a System C.S.M, la plataforma digital oficial para la gestión integral de trámites para personas jurídicas y naturales en Venezuela.</CardDescription>
                </CardHeader>
                <CardContent>
