...
export default function DashboardJuridicoPage() {
  ...
  return (
    <div className="space-y-8 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-100 via-white to-white dark:from-sky-900/20 dark:via-background dark:to-background rounded-xl p-4 md:p-8 -m-4 md:-m-8 overflow-hidden">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-5">
        {mainActions.map((action, index) => (
          <Card key={index} className="flex flex-col hover:shadow-md transition-shadow duration-300 bg-card/80 backdrop-blur-sm">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="hover:shadow-md transition-shadow duration-300 bg-card/80 backdrop-blur-sm">
          <CardHeader>
