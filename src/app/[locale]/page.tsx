...
import { User, Menu, Layers, Cpu, Users, BarChart, ShieldCheck, ShoppingCart, Send, Loader2, Building, Megaphone, Briefcase, Gavel, Smile, Clock, CheckCircle as CheckCircleIcon, Banknote, Signal, ArrowRight, Mail, Phone, Shield } from "lucide-react";
...
const SmoothScrollLink: FC<AnchorHTMLAttributes<HTMLAnchorElement>> = ({ href, ...props }) => {
    const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
        ...
        // This attempts to find and click the close button of the sheet
    ...
    <div className="flex flex-col min-h-dvh bg-background text-foreground">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
            ...
            <div className="absolute -z-10 inset-0 bg-gradient-to-t from-background via-background/50 to-transparent"></div>
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                     {services.map((item, index) => (
                        <div key={item.title} className="p-8 rounded-xl border bg-card/50 backdrop-blur-sm shadow-sm transition-all hover:shadow-primary/20 hover:-translate-y-2" style={{animationDelay: `${index * 150}ms`}}>
        ...
        {/* Features Section */}
        <AnimatedSection id="caracteristicas" className="py-20 md:py-28 bg-muted/30">
        ...
        <AnimatedSection id="nosotros" className="py-20 md:py-28 bg-background">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
