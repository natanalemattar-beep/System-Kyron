  ...
  return (
    <div className="flex flex-col min-h-dvh bg-background text-foreground">
      ...
      <header className={cn(
          ...
          isScrolled ? "bg-background/80 backdrop-blur-lg border-b" : "bg-transparent text-white border-b border-transparent"
      )}>
          <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
              <Link href="/" className="flex items-center gap-3">
                  <Logo className={cn(isScrolled ? "" : "bg-white/20 text-white")} />
        ...
        <section className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
            ...
            <div className="container px-4 md:px-6 relative z-10">
                <div className="animate-fade-up">
                    ...
                    <p className="mt-6 text-lg md:text-xl text-white/80 max-w-3xl mx-auto text-balance">
