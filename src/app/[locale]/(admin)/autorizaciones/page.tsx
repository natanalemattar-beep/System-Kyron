    ...
    <div className="space-y-12 pb-20">
      <header className="border-l-4 border-primary pl-8 py-2 mt-10 flex flex-col md:flex-row justify-between items-end gap-8">
        <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider opacity-40 mt-2 italic">Certificaciones de Entes Públicos • Cumplimiento 2026</p>
        </div>
      ...
      <Card className="glass-card border-none bg-amber-500/5 p-12 rounded-2xl mt-10 relative overflow-hidden shadow-lg border-l-4 border-amber-500">
        <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
                <div className="flex items-center gap-4">
                    <ShieldAlert className="h-8 w-8 text-amber-500 animate-pulse" />
                    <h3 className="text-2xl font-semibold uppercase italic tracking-tight text-white">Próximos Vencimientos</h3>
                </div>
            ...
            <div className="p-10 rounded-2xl bg-black/40 border border-white/5 shadow-inner">
                <h4 className="text-[10px] font-semibold uppercase tracking-wider text-amber-500 mb-10 flex items-center gap-3 italic">
                    <Terminal className="h-4 w-4" /> Estatus de Trámite: EN REVISIÓN
                </h4>
                <div className="space-y-6">
                    <div className="flex justify-between items-center text-[11px] font-semibold uppercase tracking-widest text-white/40">
