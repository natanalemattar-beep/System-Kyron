        ...
        <div className="space-y-12 pb-20">
            <header className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 border-l-4 border-primary pl-8 py-2 mt-10">
                <div className="space-y-2">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-primary/10 border border-primary/20 text-[11px] font-semibold uppercase tracking-wider text-primary mb-4">
                        <Archive className="h-3 w-3" /> CENTRO DE EXISTENCIAS
                    </div>
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground uppercase leading-none">Kardex <span className="text-primary italic">de Inventario</span></h1>
                    <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider opacity-40 mt-2 italic">Gestión de Riesgo • Liquidación Preventiva 2026</p>
                </div>
                <div className="flex gap-2">
                    <Button variant="outline" className="h-12 px-6 rounded-xl text-[10px] font-semibold uppercase tracking-widest border-border bg-card/50" onClick={fetchInventario} disabled={loading}>
                        <RefreshCw className={cn("mr-2 h-4 w-4", loading && "animate-spin")} /> ACTUALIZAR
                    </Button>
                    <Button variant="outline" className="h-12 px-6 rounded-xl text-[10px] font-semibold uppercase tracking-widest border-border bg-card/50" onClick={handleExportCSV}>
                        <Download className="mr-2 h-4 w-4" /> EXPORTAR CSV
                    </Button>
                    <Button className="h-12 px-8 rounded-xl font-semibold text-[10px] uppercase tracking-widest shadow-lg" onClick={() => setShowDialog(true)}>
            ...
            <AnimatePresence>
                {activeAlert && (
                    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="grid lg:grid-cols-3 gap-8">
                        <Card className="lg:col-span-2 glass-card border-none bg-rose-500/5 p-8 rounded-2xl shadow-lg border-l-4 border-rose-500 relative overflow-hidden group">
                            ...
                            <div className="flex flex-col md:flex-row gap-10 items-start relative z-10">
                                <div className="space-y-6 flex-1">
                                    <div className="space-y-2">
                                        <Badge className="bg-rose-500/20 text-rose-500 border-none text-[10px] font-semibold uppercase tracking-widest">Alerta de Vencimiento Crítica</Badge>
                                        <h3 className="text-2xl font-semibold uppercase italic tracking-tight text-foreground">Riesgo en SKU: {activeAlert.sku ?? "S/N"}</h3>
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase">{activeAlert.nombre}</p>
                                    </div>
                                    <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-4">
                                        <div className="flex items-center gap-3">
                                            <TrendingDown className="h-5 w-5 text-rose-500" />
                                            <h4 className="text-xs font-semibold uppercase text-rose-500">Análisis Predictivo</h4>
                                        </div>
                                        <p className="text-xs font-medium italic text-muted-foreground/80 leading-relaxed text-justify uppercase">
                                            El lote vence el <span className="text-rose-500 font-bold">{activeAlert.fecha_vencimiento ?? "N/A"}</span>. Se recomienda liquidar mediante estrategia de volumen para proteger la inversión de capital.
                                        </p>
                                    </div>
                                </div>
                                <div className="w-full md:w-64 space-y-4">
                                    <div className="p-6 bg-primary/10 border border-primary/20 rounded-2xl text-center">
                                        <p className="text-[10px] font-semibold uppercase text-primary mb-2">Valor en riesgo</p>
                                        <p className="text-sm font-bold text-white leading-tight uppercase">
                                            {formatCurrency(activeAlert.stock_actual * parseFloat(activeAlert.costo_unitario), 'Bs.')}
                                        </p>
                                    </div>
                                    <Button className="w-full h-14 rounded-2xl font-semibold uppercase text-[10px] tracking-widest shadow-xl" onClick={async () => {
                                        try {
                        ...
                        <Card className="glass-card border-none bg-card/40 p-8 rounded-2xl shadow-lg flex flex-col justify-center text-center relative overflow-hidden group">
                            ...
                            <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground/40 mb-6">Valor en Riesgo Total</p>
                            <p className="text-5xl font-bold text-rose-500 tracking-tight-sm">
                            ...
                            <div className="mt-8 pt-8 border-t border-white/5 flex items-center justify-center gap-3 text-[11px] font-semibold uppercase text-muted-foreground/40">
            ...
            <div className="grid gap-6 md:grid-cols-4">
                <Card className="glass-card border-none bg-card/40 p-8 rounded-[2.5rem] shadow-lg relative overflow-hidden group">
                    ...
                    <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground/40 mb-4">Valor Total Almacén</p>
                    <p className="text-3xl font-bold text-primary tracking-tight">{loading ? "—" : formatCurrency(valorTotal, 'Bs.')}</p>
                </Card>
                <Card className="glass-card border-none bg-card/40 p-8 rounded-[2.5rem] shadow-lg relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-6 opacity-5"><Activity className="h-24 w-24" /></div>
                    <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground/40 mb-4">Total Productos</p>
                    <p className="text-3xl font-bold text-foreground tracking-tight">{loading ? "—" : stats?.total_items ?? 0}</p>
                </Card>
                <Card className="glass-card border-none bg-card/40 p-8 rounded-[2.5rem] shadow-lg relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-6 opacity-5"><ShieldAlert className="h-24 w-24 text-rose-500" /></div>
                    <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground/40 mb-4">Por Vencer (30d)</p>
                    <p className={cn("text-3xl font-bold tracking-tight", parseInt(stats?.items_criticos ?? "0") > 0 ? "text-rose-500" : "text-emerald-500")}>{loading ? "—" : stats?.items_criticos ?? 0}</p>
                </Card>
                <Card className="glass-card border-none bg-card/40 p-8 rounded-[2.5rem] shadow-lg relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-6 opacity-5"><Archive className="h-24 w-24" /></div>
                    <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground/40 mb-4">Categorías</p>
                    <p className="text-3xl font-bold text-foreground tracking-tight">{loading ? "—" : stats?.categorias ?? 0}</p>
                </Card>
            </div>
            ...
            <Card className="glass-card border-none rounded-2xl bg-card/40 overflow-hidden shadow-lg">
                <CardHeader className="p-10 border-b border-border/50 flex flex-row justify-between items-center bg-muted/10">
                    <CardTitle className="text-sm font-semibold uppercase tracking-wider text-primary italic">Kardex de Existencias Auditado</CardTitle>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-muted/30 border-none">
                                <TableHead className="pl-10 py-5 text-[11px] font-semibold uppercase tracking-widest opacity-30">SKU / Ref</TableHead>
                                <TableHead className="py-5 text-[11px] font-semibold uppercase tracking-widest opacity-30">Producto</TableHead>
                                <TableHead className="text-center py-5 text-[11px] font-semibold uppercase tracking-widest opacity-30">Stock</TableHead>
                                <TableHead className="text-center py-5 text-[11px] font-semibold uppercase tracking-widest opacity-30">Vencimiento</TableHead>
                                <TableHead className="text-right py-5 text-[11px] font-semibold uppercase tracking-widest opacity-30">Costo</TableHead>
                                <TableHead className="text-right py-5 text-[11px] font-semibold uppercase tracking-widest opacity-30">Venta</TableHead>
                                <TableHead className="text-right pr-10 py-5 text-[11px] font-semibold uppercase tracking-widest opacity-30">Riesgo</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {loading ? (
                                ...
                                <TableRow><TableCell colSpan={7} className="py-16 text-center">
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        <p className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground/40">Inventario vacío</p>
                                        <Button className="mt-2 h-10 px-6 rounded-xl font-bold text-[11px] uppercase" onClick={() => setShowDialog(true)}>
                                ...
                                return (
                                    <TableRow key={item.id} className={cn(
                                        ...
                                        <TableCell className="pl-10 py-6 font-mono text-[10px] font-bold text-primary italic">{item.sku ?? "—"}</TableCell>
                                        <TableCell className="py-6">
                                            <p className="font-semibold text-xs text-foreground/80 uppercase italic group-hover:text-primary transition-colors">{item.nombre}</p>
                                            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">{item.categoria} · {item.unidad_medida}</p>
                                        </TableCell>
                                        <TableCell className="text-center py-6">
                                            <span className={cn("font-semibold text-sm", item.stock_actual <= item.stock_minimo ? "text-rose-500" : "text-foreground/70")}>{item.stock_actual}</span>
                                        </TableCell>
                                        <TableCell className="text-center py-6">
                                        ...
                                        <TableCell className="text-right pr-10 py-6">
                                            <div className="flex items-center justify-end gap-2">
                                                <Badge variant={riesgo === "Crítico" || riesgo === "Vencido" ? 'destructive' : riesgo === "Alerta" ? 'outline' : 'outline'} className={cn("text-[10px] font-semibold uppercase tracking-widest h-6 px-3 rounded-lg", riesgo === "Alerta" && "border-amber-500/30 text-amber-500")}>
                                                    {riesgo}
                                                </Badge>
                ...
                <CardFooter className="p-10 bg-primary/5 border-t border-border flex justify-center">
                    <p className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/40 italic">Datos en tiempo real desde la base de datos. Haga clic en un producto crítico para activar el protocolo de liquidación.</p>
                </CardFooter>
            </Card>
            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent className="max-w-2xl bg-card border-border rounded-xl p-0 overflow-hidden">
                    <DialogHeader className="p-8 pb-4 border-b border-border bg-muted/10">
                        ...
                        <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest mt-1">Todos los campos marcados son obligatorios</p>
                    </DialogHeader>
                    <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[60vh] overflow-y-auto">
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Nombre del Producto *</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">SKU / Referencia</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Categoría</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Unidad de Medida</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Stock Actual *</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Stock Mínimo (Alerta)</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Costo Unitario (Bs.) *</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Precio de Venta (Bs.)</Label>
                        ...
                        <div className="space-y-2">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest">Descripción</Label>
