    ...
    <div className="space-y-10 pb-20 px-4 md:px-10 bg-background min-h-screen">
      <header className="flex flex-col md:flex-row justify-between items-end gap-8 border-l-4 border-primary pl-8 py-2 mt-10">
        ...
        <div className="flex gap-2">
          <Button variant="outline" asChild className="h-12 px-6 rounded-xl text-[10px] font-black uppercase tracking-widest border-border bg-card/50">
              <a href="/inventario-central"><PlusCircle className="mr-2 h-4 w-4" /> Agregar Producto</a>
            </Button>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="glass-card border-none bg-card/40 p-2 rounded-[2rem] shadow-sm hover:shadow-xl transition-all">
          ...
          <CardContent className="p-6 pt-0">
            <div className="text-2xl font-black italic tracking-tight text-emerald-500">{summary.totalItems}</div>
        ...
        <Card className="glass-card border-none bg-card/40 p-2 rounded-[2rem] shadow-sm hover:shadow-xl transition-all">
          ...
          <CardContent className="p-6 pt-0">
            <div className={cn("text-2xl font-black italic tracking-tight", summary.lowStock > 0 ? "text-amber-500" : "text-emerald-500")}>{summary.lowStock}</div>
