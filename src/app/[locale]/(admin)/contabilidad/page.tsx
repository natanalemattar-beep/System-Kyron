...
const accountingSections = [
  {
    title: "Libros Contables Principales",
    icon: BookOpen,
    description: "Registros legales y control de existencias bajo normativa venezolana.",
    items: [
      { label: "Compra y Venta", href: "/contabilidad/libros/compra-venta", kpi: "Marzo: Al día", icon: FileText, color: "text-blue-600" },
  ...
  {
    title: "Gestión de Impuestos y Tasas",
    icon: Landmark,
    ...
    items: [
      ...
      { label: "Retenciones (IVA/ISLR)", href: "/contabilidad/impuestos/retenciones", kpi: "Comprobantes", icon: ShieldCheck, color: "text-emerald-600" },
      { label: "Municipales", href: "/contabilidad/impuestos/municipales", kpi: "Patentes Locales", icon: Landmark, color: "text-blue-600" },
      { label: "Calendario Fiscal", href: "/contabilidad/impuestos/calendario", kpi: "Ver Agenda", icon: Calendar, color: "text-amber-600" },
      { label: "Homologación", href: "/contabilidad/impuestos/homologacion", kpi: "Equipos Fiscales", icon: CheckCircle, color: "text-slate-600" },
      { label: "Multas y Sanciones", href: "/contabilidad/impuestos/multas", kpi: "Control Legal", icon: ShieldAlert, color: "text-rose-600" },
      { label: "Reportes Fiscales", href: "/contabilidad/impuestos/reportes", kpi: "Analíticos", icon: FileSearch, color: "text-blue-600" },
    ]
  },
  {
    title: "Tesorería y Cuentas",
    icon: Wallet,
    ...
    items: [
      ...
      { label: "Arqueo de Caja", href: "/arqueo-caja", kpi: "Cierre Diario", icon: Calculator, color: "text-blue-600" },
  ...
  },
  {
    ...
    icon: BarChart3,
    description: "Análisis avanzado de rentabilidad y proyecciones estratégicas.",
    items: [
      ...
      { label: "Reportes Maestros", href: "/reports", kpi: "Dossier Global", icon: FileText, color: "text-slate-600" },
    ]
  }
];
      ...
      <header className="flex flex-col md:flex-row justify-between items-end gap-8 border-l-4 border-[#0A2472] pl-8 py-2 mt-10">
        <div className="space-y-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-[#0A2472]/10 border border-[#0A2472]/20 text-[9px] font-black uppercase tracking-[0.4em] text-[#0A2472] mb-3">
                <Calculator className="h-3 w-3" /> SISTEMA FINANCIERO INTEGRAL
            </div>
            ...
            <p className="text-slate-500 text-[10px] font-bold uppercase tracking-[0.6em] mt-2 italic">Control de Libros e Impuestos • Ejercicio 2026</p>
        </div>
            ...
            <Card className="border-none bg-amber-50 rounded-[2.5rem] p-8 shadow-sm border-l-4 border-amber-500">
                <CardHeader className="p-0 mb-8">
                    <CardTitle className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-600 flex items-center gap-3">
                        <ShieldAlert className="h-4 w-4" /> Vencimientos Urgentes
                    </CardTitle>
                </CardHeader>
                <CardContent className="p-0 space-y-4">
                    {[
                        ...
                        { text: "Última conciliación: hoy 08:00", color: "text-emerald-600", icon: CheckCircle }
                    ].map((alert, i) => (
