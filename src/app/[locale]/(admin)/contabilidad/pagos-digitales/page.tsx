...
const mediosPago = [
  ...
  },
  {
    ...
    usd: "≈ $42.435 USD",
    comision: "0% comisión",
    redes: ["BdV 0102", "Banesco 0134", "Mercantil 0105", "BBVA 0108", "BNC 0191", "BOD 0116", "Bancaribe 0114", "BFC 0151", "Bicentenario 0175", "Tesoro 0163"],
    estado: "ACTIVO",
  },
  {
    ...
    redes: ["USDT TRC-20", "USDC ERC-20", "BTC Lightning", "ETH", "Binance Pay"],
    estado: "ACTIVO",
  },
  {
    tipo: "Reserve / Stablecoin",
    icon: Wallet,
    color: "text-sky-500",
    bg: "bg-sky-500/10",
    ...
    transacciones: 43,
    monto: "$3.210 USDC",
    usd: "Bs. 161.916,00 (BCV)",
    comision: "0.1% conversión",
    redes: ["Reserve App", "USDC Circle", "Stablecoin P2P"],
    estado: "ACTIVO",
  },
  {
    ...
    transacciones: 312,
    monto: "$18.740 USD + €2.150 EUR",
    usd: "Bs. 985.430,00 (BCV)",
    comision: "0% comisión",
    redes: ["USD Cash", "EUR Cash", "Registro Manual"],
    estado: "ACTIVO",
  },
];
...
const pagoMovilRecientes = [
  ...
  { cedula: "V-27.445.891", nombre: "Luisa Fernanda Mora", banco: "BFC (0151)", monto: "Bs. 35.200,00", ref: "202603180007", hora: "01:15 PM", estado: "VERIFICADO", segundos: 2 },
  { cedula: "J-41.234.567-3", nombre: "Inversiones Norte C.A.", banco: "Bicentenario (0175)", monto: "Bs. 520.000,00", ref: "202603180008", hora: "02:03 PM", estado: "VERIFICADO", segundos: 3 },
  { cedula: "V-22.678.123", nombre: "Andrés Felipe Rivas", banco: "Bancamiga (0172)", monto: "Bs. 18.900,00", ref: "202603180009", hora: "02:48 PM", estado: "VERIFICADO", segundos: 2 },
  { cedula: "V-19.345.678", nombre: "Carmen Teresa López", banco: "Tesoro (0163)", monto: "Bs. 42.100,00", ref: "202603180010", hora: "03:22 PM", estado: "VERIFICADO", segundos: 4 },
];
