                    ...
                    <Card className="glass-card border-none rounded-[3rem] bg-white/[0.02] overflow-hidden shadow-2xl">
                        ...
                        <CardContent className="p-10 space-y-10">
                            <div className="space-y-3">
                                <Label className="text-[9px] font-black uppercase text-white/40 ml-1">Monto del Tributo Omitido (Bs.)</Label>
                                <Input 
                                    type="number" 
                                    placeholder="0.00" 
                            ...
                            <div className="space-y-4 pt-6">
                                <div className="flex justify-between items-center text-sm border-b border-white/5 pb-3">
                                    <span className="text-white/30 uppercase font-bold text-[10px] tracking-widest">Multa Estimada (COT 200%)</span>
                                ...
                                <div className="flex justify-between items-center p-8 bg-rose-500/5 rounded-[2rem] border border-rose-500/10">
                                    <span className="font-black uppercase text-xs text-rose-600 italic tracking-tighter">Total Proyectado a Pagar</span>
