...
import { Ship, Download, CheckCircle, Activity, Terminal, ShieldCheck, PlusCircle } from "lucide-react";
            ...
            <header className="border-l-4 border-primary pl-8 py-2 mt-10 flex flex-col md:flex-row justify-between items-end gap-8">
                <div className="space-y-2">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-primary/10 border border-primary/20 text-[9px] font-black uppercase tracking-[0.4em] text-primary shadow-glow mb-4">
                        <Ship className="h-3 w-3" /> NODO EXPORTADOR
                    </div>
                        ...
                        <CardContent className="p-10 space-y-8">
                            <div className="grid md:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <Button variant="outline" className="w-full h-12 rounded-xl border-border bg-white/5 text-[9px] font-black uppercase tracking-widest" onClick={() => alert("Asesoría disponible en la versión completa")}>SOLICITAR HABILITACIÓN</Button>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
