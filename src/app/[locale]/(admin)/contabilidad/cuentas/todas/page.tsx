    ...
    <div className="p-6 md:p-12 bg-background min-h-screen space-y-12">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground font-bold text-sm uppercase tracking-widest opacity-60">Repositorio Central de Tesorería y Bancos</p>
        </div>
      </header>
      ...
      <footer className="pt-20 pb-10 text-center opacity-20 border-t border-border">
        <p className="text-[10px] font-black uppercase tracking-[1em] text-foreground italic">SYSTEM KYRON • BANKING NODE • 2026</p>
      </footer>
    </div>
  );
}
