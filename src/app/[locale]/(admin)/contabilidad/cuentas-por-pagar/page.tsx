...
import { HandCoins, Search, Loader2, Inbox, Printer, TriangleAlert, TrendingDown, Users, Clock, Plus, Trash2, Pencil } from "lucide-react";
      ...
      {rows.length > 0 && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="rounded-2xl border p-5">
            ...
            <p className="text-2xl font-bold">{formatCurrency(summary.totalSaldo, 'Bs.')}</p>
          </Card>
          <Card className="rounded-2xl border p-5">
            <div className="flex items-center justify-between mb-2">
          ...
          <Card className="rounded-2xl border p-5">
            ...
            <p className="text-2xl font-bold">{summary.proveedores}</p>
          </Card>
          <Card className="rounded-2xl border p-5">
            <div className="flex items-center justify-between mb-2">
