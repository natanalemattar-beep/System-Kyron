...
import { User, ShieldCheck, KeyRound, Mail, Smartphone, MapPin, Building, Globe, Zap, History, LogOut, ShieldAlert } from "lucide-react";
  ...
  return (
    <div className="space-y-12 pb-20 px-4 md:px-16 max-w-6xl mx-auto">
      <header className="border-l-4 border-primary pl-8 py-2 mt-10">
        ...
        <h1 className="text-3xl md:text-5xl font-black tracking-tight text-foreground uppercase leading-none italic-shadow text-white">Gestión de <span className="text-primary italic">Perfil</span></h1>
        <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-[0.6em] opacity-40 mt-2 italic">Credenciales Consolidadas • Acceso Autorizado 2026</p>
      </header>
        ...
        <div className="lg:col-span-4 space-y-10">
            <Card className="glass-card border-none bg-card/40 p-10 rounded-[3rem] text-center shadow-2xl flex flex-col items-center group overflow-hidden">
                ...
                <div className="space-y-2 mb-8 relative z-10">
                    <h2 className="text-2xl font-black uppercase italic tracking-tighter text-white">Administrador</h2>
                    <p className="text-[10px] font-bold text-primary uppercase tracking-[0.3em] italic">Autoridad Global</p>
                </div>
                <Badge className="bg-emerald-500/20 text-emerald-400 border-none px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-glow-secondary mb-8">IDENTIDAD SELLADA</Badge>
            ...
            <Card className="glass-card border-none bg-primary/5 p-10 rounded-[3rem] shadow-2xl">
                <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-primary mb-8 italic border-b border-primary/10 pb-4">Nivel de Seguridad</h3>
                <div className="space-y-6">
                    <div className="flex justify-between items-center border-b border-white/5 pb-4">
                        <div className="flex items-center gap-3"><ShieldAlert className="h-4 w-4 text-primary/40" /><span className="text-[9px] font-bold text-muted-foreground uppercase">Autoridad</span></div>
                        <span className="text-[9px] font-black text-primary uppercase">TOTAL (GRADO 5)</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-white/5 pb-4">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-[9px] font-black text-white">AES-512</span>
                    </div>
                </div>
            </Card>
        </div>
        ...
        <div className="lg:col-span-8 space-y-10">
            <Card className="glass-card border-none rounded-[3rem] bg-card/40 overflow-hidden shadow-2xl">
                <CardHeader className="p-10 border-b border-white/5 bg-muted/10">
                    <CardTitle className="text-sm font-black uppercase tracking-[0.4em] text-primary italic">Registro de Identidad Digital</CardTitle>
                </CardHeader>
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 shadow-inner">
                                    ...
                                    <span className="text-xs font-bold text-white/80">admin@kyron.com</span>
                                </div>
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 shadow-inner">
                                    ...
                                    <span className="text-xs font-bold text-white/80">System Kyron, C.A.</span>
                                </div>
                            </div>
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 shadow-inner">
                                    ...
                                    <span className="text-xs font-bold text-white/80">Distrito Capital, VEN</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <CardFooter className="p-10 bg-primary/5 border-t border-white/5 flex justify-between items-center">
                    <Button variant="outline" className="h-12 px-8 rounded-xl border-white/5 bg-card/50 text-[9px] font-black uppercase tracking-widest hover:bg-card/80 transition-all text-white/40" onClick={() => alert("Función de seguridad en desarrollo")}>CAMBIAR CLAVE</Button>
            ...
            <Card className="glass-card border-none p-10 rounded-[3rem] bg-white/[0.02] shadow-2xl relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-8 opacity-[0.02] group-hover:rotate-12 transition-transform duration-1000"><ShieldCheck className="h-48 w-48 text-primary" /></div>
                <h3 className="text-xl font-black uppercase italic tracking-tighter text-white mb-6">Bóveda Biométrica</h3>
                <p className="text-sm font-bold text-muted-foreground/60 leading-relaxed uppercase mb-8 text-justify">
                    Su identidad está sellada mediante el protocolo de seguridad Kyron v2.6.5. Cada acceso administrativo requiere validación cruzada entre su terminal móvil y la ID digital inmutable registrada en el Ledger. Esto garantiza que su rango de **Autoridad Total** no sea vulnerado.
                </p>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {["Reconocimiento Facial", "Huella Digital", "Token Hardware", "Clave Maestra"].map((auth, i) => (
                        <div key={i} className="p-4 rounded-2xl bg-white/5 border border-white/5 text-center">
                            <Badge className="bg-emerald-500/20 text-emerald-400 border-none text-[7px] font-black uppercase mb-2">ACTIVE</Badge>
                            <p className="text-[8px] font-black uppercase tracking-widest text-white/20 leading-tight">{auth}</p>
                        </div>
                    ))}
                </div>
            </Card>
