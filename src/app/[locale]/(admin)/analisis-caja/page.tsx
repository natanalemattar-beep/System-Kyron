            ...
            <div className="lg:col-span-7 space-y-10">
                ...
                <Card className="glass-card border-none p-10 rounded-[3rem] bg-card/40 shadow-2xl">
                    ...
                    <CardContent className="p-0 space-y-6">
                        ...
                        <Button className="h-12 px-8 rounded-xl btn-3d-primary font-black uppercase text-[9px] tracking-widest shadow-xl w-full">EJECUTAR CONVERSIÓN</Button>
                    </CardContent>
                </Card>
            </div>
            <div className="lg:col-span-5 space-y-10">
                ...
                <Card className="glass-card border-none rounded-[3rem] bg-white/[0.02] p-8 border border-white/5">
                    ...
                    <div className="space-y-4 text-[9px] font-bold uppercase tracking-widest text-muted-foreground/40">
                        <div className="flex justify-between border-b border-border/50 pb-2"><span>Solvencia:</span> <span className="text-emerald-500 font-black">2.45 (ÓPTIMO)</span></div>
