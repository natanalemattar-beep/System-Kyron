  ...
  children: React.ReactNode;
    ...
    return (
      <div className="flex min-h-screen bg-muted/5 relative overflow-hidden">
          {/* Identidad Visual: Contabilidad / Finanzas */}
          <div className="absolute inset-0 pointer-events-none -z-10">
            <div className="absolute inset-0 opacity-[0.05] [background-image:linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] [background-size:40px_40px]" />
            <div className="absolute top-1/4 left-1/4 w-full h-full bg-primary/[0.02] rounded-full blur-[150px]" />
          </div>
          ...
          <div className="flex-1 lg:pl-64 flex flex-col min-h-screen">
              ...
              >
                  ...
                  <div className="absolute bottom-20 left-10 opacity-[0.01] pointer-events-none">
