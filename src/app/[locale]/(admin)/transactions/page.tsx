  ...
  return (
    <div className="space-y-10 px-6 md:px-10 pb-20">
      <header className="border-l-4 border-primary pl-8 py-2">
        ...
        <h1 className="text-3xl font-black tracking-tight text-foreground uppercase leading-none italic">Registro de <span className="text-primary">Operaciones</span></h1>
