"use client";
  ...
  import {Loader2, Plus, Search, Trash2, ArrowLeft, Users, CircleCheck, Building, Clock, TriangleAlert, XCircle, FileText, Shield, Briefcase, Scale, ShieldCheck, FileSignature, Activity, Wallet, DollarSign, Car, Heart, Globe, Package, UserCheck, Receipt, ShoppingCart, CreditCard, Stethoscope, ShieldAlert, Smartphone, MapPin, Star, Send, Eye, Calendar, Hash, Landmark} from "lucide-react";
