            ...
            <Card className="lg:col-span-4 bg-primary text-primary-foreground rounded-[2rem] overflow-hidden relative group p-1 shadow-2xl border-none">
                ...
                <div className="p-8 space-y-6 relative z-10 bg-primary rounded-[1.9rem] h-full flex flex-col justify-between min-h-[240px]">
                    <div className="space-y-1">
                        <CardTitle className="text-2xl font-black uppercase italic tracking-tighter leading-tight text-white">Archivos Protegidos</CardTitle>
                    ...
                    <div className="space-y-4">
                        <p className="text-xs font-bold opacity-80 leading-relaxed italic text-white">
                            Acceso seguro a expedientes corporativos y protocolos de cumplimiento.
                        </p>
