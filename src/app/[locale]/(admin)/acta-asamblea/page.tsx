  ...
  return (
    <div className="space-y-12 pb-20">
      <header className="border-l-4 border-primary pl-8 py-2 mt-10">
        ...
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground uppercase leading-none">Actas <span className="text-primary italic">de Asamblea</span></h1>
        <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider opacity-40 mt-2 italic">Gobierno Corporativo • Libros de Accionistas 2026</p>
      </header>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-8">
            <Card className="glass-card border-none rounded-2xl bg-card/40 overflow-hidden shadow-lg">
                <CardHeader className="p-10 border-b border-border/50 bg-muted/10">
                    <CardTitle className="text-sm font-semibold uppercase tracking-wider text-primary italic">Generador de Acta Inteligente</CardTitle>
                </CardHeader>
                <CardContent className="p-10 space-y-8">
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/40 ml-1">Tipo de Asamblea</Label>
                        ...
                        <div className="space-y-3">
                            <Label className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/40 ml-1">Fecha de Sesión</Label>
                    ...
                    <div className="space-y-3">
                        <Label className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/40 ml-1">Deliberaciones y Acuerdos</Label>
                ...
                <CardFooter className="p-10 bg-primary/5 border-t border-border flex justify-between items-center">
                    ...
                    <div className="flex gap-3">
                        <Button variant="outline" className="h-12 px-6 rounded-xl border-border bg-card/50 text-[11px] font-semibold uppercase tracking-widest" onClick={() => handleAction('impresión')}>
                            <Printer className="mr-2 h-4 w-4" /> IMPRIMIR
                        </Button>
                        <Button className="h-12 px-8 rounded-xl font-semibold uppercase text-[11px] tracking-widest shadow-xl" onClick={() => handleAction('registro')}>
                            REGISTRAR Y SELLAR
                        </Button>
                    </div>
                </CardFooter>
        ...
        <div className="lg:col-span-4 space-y-8">
            <Card className="glass-card border-none p-10 rounded-2xl bg-card/40 shadow-lg relative overflow-hidden group">
                ...
                <h3 className="text-xl font-semibold uppercase italic tracking-tight text-foreground mb-6">Custodia de Libros</h3>
                ...
                <div className="p-6 rounded-2xl bg-white/5 border border-border shadow-inner">
                    <div className="flex justify-between items-center text-[11px] font-bold uppercase tracking-widest text-primary mb-2">
