    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="glass-card border-none bg-card/40 p-8 rounded-[2.5rem] shadow-2xl">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground/40 mb-4">Costos Registrados</p>
          <p className="text-4xl font-black italic text-foreground tracking-tight">
        ...
        <Card className="glass-card border-none bg-emerald-500/5 rounded-[2.5rem] p-8 shadow-2xl border-l-4 border-emerald-500">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald-500/60 mb-4">Margen Bruto</p>
          <p className="text-4xl font-black italic text-emerald-500 tracking-tight">
        ...
        <Card className="glass-card border-none bg-primary/5 rounded-[2.5rem] p-8 shadow-2xl border-l-4 border-primary">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-primary/60 mb-4">Categorías de Gasto</p>
          <p className="text-4xl font-black italic text-primary tracking-tight">
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 space-y-8">
          <Card className="glass-card border-none p-10 rounded-[3rem] bg-white/[0.02] shadow-2xl">
            <h3 className="text-xl font-black uppercase italic tracking-tight text-foreground mb-4">Análisis de Sensibilidad</h3>
