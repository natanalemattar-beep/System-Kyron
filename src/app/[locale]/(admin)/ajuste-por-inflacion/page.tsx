  ...
  return (
    <div className="space-y-12 pb-20 px-6 md:px-10">
      <header className="border-l-4 border-primary pl-8 py-2 mt-10">
        ...
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground uppercase leading-none">Reajuste por <span className="text-primary italic">Inflación Fiscal</span></h1>
        <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider opacity-40 mt-2 italic">Actualización de Activos No Monetarios • Normativa LISLR 2026</p>
      </header>

      <div className="grid lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-10">
            <Card className="glass-card border-none rounded-2xl p-10 bg-card/40 shadow-xl shadow-blue-500/5">
                <CardHeader className="p-0 mb-6">
                    <CardTitle className="text-xl font-semibold uppercase italic tracking-tight text-foreground flex items-center gap-4">
             ...
             <Card className="glass-card border-none rounded-2xl p-10 bg-card/40 shadow-xl">
                <CardHeader className="p-0 mb-8">
                    <CardTitle className="text-xl font-semibold uppercase italic tracking-tight text-foreground">Sujetos Obligados</CardTitle>
                </CardHeader>
        ...
        <div className="lg:col-span-1">
            <Card className="bg-rose-600/10 border-2 border-rose-600/20 rounded-[2.5rem] p-10 flex flex-col justify-between relative overflow-hidden group shadow-lg">
                <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:rotate-12 transition-transform duration-1000">
                    <FileWarning className="h-32 w-32" />
                </div>
                <div className="relative z-10">
                    <h3 className="text-2xl font-semibold uppercase italic tracking-tight text-rose-500 mb-4">RIESGO DE SANCIÓN</h3>
                ...
                <Button variant="destructive" className="w-full h-14 rounded-2xl font-semibold uppercase text-xs tracking-widest shadow-lg relative z-10">AUDITAR ESTADOS FINANCIEROS</Button>
            </Card>
        </div>
      </div>
       ...
       <Card className="glass-card border-none rounded-[3.5rem] bg-card/40 shadow-lg overflow-hidden mt-10">
        ...
        <CardContent className="p-12 grid md:grid-cols-3 gap-10">
            {calculoSimplificado.map(paso => (
                <div key={paso.paso} className="p-8 bg-muted/20 border border-border rounded-[2.5rem] space-y-4 hover:border-primary/30 transition-all group">
                    <p className="text-[11px] font-semibold uppercase text-primary tracking-widest">PASO 0{paso.paso}</p>
                    <h3 className="font-semibold text-sm uppercase italic text-foreground/90 group-hover:text-primary">{paso.titulo}</h3>
        ...
        <CardFooter className="p-12 bg-primary/5 flex justify-between items-center border-t border-border">
            <div className="flex items-center gap-4 text-[11px] font-bold text-muted-foreground/40 uppercase tracking-wide italic">
                <Terminal className="h-4 w-4" /> Ejecución Automática System Kyron
            </div>
            <Button className="h-12 px-8 rounded-xl font-semibold uppercase text-[10px] tracking-widest shadow-xl">SIMULAR REAJUSTE</Button>
        </CardFooter>
       </Card>
    </div>
  );
