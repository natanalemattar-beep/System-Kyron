  ...
  return (
    <div className="space-y-12 pb-20 px-4 md:px-10">
      <header className="border-l-4 border-primary pl-8 py-2 mt-10">
        ...
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground uppercase leading-none">Trámites <span className="text-primary italic">Fiscales</span></h1>
        <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider opacity-40 mt-2 italic">Oficina Virtual de Impuestos • Sincronización SENIAT 2026</p>
      </header>
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {tramites.map((tramite, i) => (
            <motion.div key={tramite.title} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }}>
                <Card className="glass-card border-none bg-card/40 p-8 rounded-[2.5rem] h-full flex flex-col justify-between shadow-lg group hover:border-primary/30">
                    <div className="space-y-6">
                        ...
                        <div>
                            <CardTitle className="text-xl font-semibold uppercase italic tracking-tight text-foreground mb-2">{tramite.title}</CardTitle>
                    ...
                    <CardFooter className="p-0 pt-10">
                        <Button asChild variant="outline" className="w-full h-12 rounded-xl border-border bg-white/5 text-[11px] font-semibold uppercase tracking-widest group-hover:bg-primary group-hover:text-white transition-all">
      ...
      <Card className="bg-primary text-primary-foreground rounded-2xl p-12 relative overflow-hidden border-none group mt-10">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
                <h3 className="text-3xl font-semibold uppercase italic tracking-tight">Asistente de Auditoría 24/7</h3>
                ...
                <Button variant="secondary" className="h-14 px-10 rounded-2xl bg-white text-primary font-semibold uppercase text-xs tracking-widest shadow-lg">ACTIVAR PROTECCIÓN</Button>
            </div>
