...
const PLANES = [
    {
        ...
        icon: BookOpen,
        color: 'lightblue',
        descripcion: 'Libros legales básicos y calendario fiscal',
        features: ['Libros legales básicos (Diario, Mayor)', 'Calendario fiscal con alertas', 'Consulta RIF/Cédula (20/mes)', 'Tasa BCV en vivo', '1 usuario'],
    },
    {
        ...
        icon: Zap,
        color: 'green',
        descripcion: 'Centro tributario completo y retenciones',
        features: ['Todo en Esencial +', 'Libro de Inventario', 'Centro Tributario (IVA, ISLR, IGTF)', 'Retenciones automáticas', 'Simulador de multas COT', 'Exportación Excel', '3 usuarios'],
    },
    {
        ...
        icon: Building,
        color: 'darkblue',
        descripcion: 'IA Fiscal, conciliación y asientos automáticos',
        features: ['Todo en Profesional +', 'IA Fiscal para consultas', 'Declaraciones asistidas (12/año)', 'Conciliación bancaria', 'Asientos automáticos', 'Auditoría forense', '5 usuarios'],
    },
    {
        id: 'contable_max',
        nombre: 'MAX',
        ...
        icon: Crown,
        color: 'neon',
        descripcion: 'Multi-empresa, blockchain y soporte VIP',
        features: ['Todo en Avanzado +', 'Dictamen de Contador Público', 'Blockchain audit trail', 'Multi-empresa', 'Usuarios ilimitados', 'Soporte VIP 24/7', 'API de integración'],
    },
];
