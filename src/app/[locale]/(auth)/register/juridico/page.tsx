                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 px-1">
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="relative">
                                                    <Input type={showPassword ? 'text' : 'password'} autoComplete="new-password" {...register('password')} className="h-12 rounded-xl bg-slate-50 dark:bg-slate-800/50 border-none pr-10 focus:ring-2 focus:ring-amber-500/20" />
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <Input type="password" autoComplete="new-password" {...register('confirmPassword')} className="h-12 rounded-xl bg-slate-50 dark:bg-slate-800/50 border-none focus:ring-2 focus:ring-amber-500/20" />
                                            </div>
                                        </div>
