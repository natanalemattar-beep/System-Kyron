      ...
      >
        <header className="text-center mb-12 md:mb-16">
          ...
          >
            <div className="relative">
              ...
              <div className="relative h-16 w-16 rounded-2xl bg-gradient-to-br from-primary/20 to-cyan-500/20 border border-primary/15 flex items-center justify-center backdrop-blur-sm">
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-blue-500/15 to-indigo-500/15 border border-blue-500/15 flex items-center justify-center">
              ...
              <motion.div key={option.href} variants={itemVariants}>
                <Link href={option.href as any} className="group block">
                  ...
                  >
                    ...
                    )} style={{ boxShadow: `inset 0 1px 0 0 rgba(255,255,255,0.06), 0 8px 40px -12px ${option.glow}` }} />
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-emerald-500/15 to-teal-500/15 border border-emerald-500/15 flex items-center justify-center">
