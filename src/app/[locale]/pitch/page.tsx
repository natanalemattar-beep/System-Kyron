...
const slides = [
    ...
    },
    {
        ...
        body: "Muchos negocios pierden tiempo valioso tratando de entender cómo instalar una línea, armar una web o resolver problemas diarios. Eso frena las ventas.",
        icon: TriangleAlert,
        accent: "#f43f5e",
        bg: "from-rose-900/30 via-slate-900/20 to-transparent",
        image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1000&auto=format&fit=crop",
        script: "Dirigir un negocio ya es bastante difícil. El verdadero problema es que los emprendedores gastan horas peleando con proveedores distintos para sus líneas, su web y sus sistemas. Es un caos que cuesta tiempo y dinero.",
        stats: [
            { label: "Tiempo Perdido", value: "68%" },
            { label: "Estrés Técnico", value: "Alto" },
    ...
    },
    {
        ...
        tag: "COMUNICACIÓN",
        title: "LÍNEAS\nCORPORATIVAS",
        subtitle: "Conectamos a todo tu equipo al instante.",
        body: "Te entregamos líneas de comunicación listas para usar, con la mejor velocidad y sin contratos imposibles de entender.",
        icon: Zap,
        accent: "#06b6d4",
        bg: "from-cyan-900/30 via-blue-900/20 to-transparent",
        image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1000&auto=format&fit=crop",
        script: "Todo empieza por una buena comunicación. Nosotros te instalamos las líneas que tu equipo necesita para hablar con los clientes sin que las llamadas se caigan y sin dolores de cabeza.",
        stats: [
    ...
    },
    {
        ...
        tag: "PRESENCIA",
        title: "TU PÁGINA\nWEB",
        subtitle: "Un ecosistema digital que vende por ti.",
        body: "No hacemos plantillas aburridas. Creamos plataformas web rápidas, hermosas y listas para recibir a tus clientes como se merecen.",
        icon: Monitor,
        accent: "#10b981",
        bg: "from-emerald-900/30 via-slate-900/20 to-transparent",
        image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=1000&auto=format&fit=crop",
        script: "Hoy en día, si no estás en internet, no existes. Pero no basta con estar; hay que destacar. Nosotros construimos tu página web desde cero para que sea tu mejor vendedor, abierto las 24 horas.",
        stats: [
            { label: "Diseño", value: "Premium" },
            { label: "Velocidad", value: "Ultra Rápida" },
    ...
    },
    {
        ...
        tag: "SOLUCIONES",
        title: "SISTEMAS\nSOSTENIBLES",
        subtitle: "Organizamos tu empresa para que escale.",
        body: "Resolvemos los cuellos de botella de tu negocio con herramientas prácticas que mejoran tu sostenibilidad operativa. Cero papel, cero enredos.",
        icon: Leaf,
        accent: "#8b5cf6",
        ...
        script: "Una vez que tienes la comunicación y la web, necesitas orden. Te damos herramientas sostenibles para digitalizar tus procesos, eliminar el papel y hacer que trabajar sea un placer, no una carga.",
        stats: [
            { label: "Organización", value: "Total" },
            { label: "Papel", value: "Cero" },
            { label: "Crecimiento", value: "Escalable" },
        ],
    },
    {
        id: "traction",
        tag: "RESULTADOS",
        title: "CLIENTES\nFELICES",
        subtitle: "Negocios reales creciendo con nosotros.",
        body: "No somos solo promesas. Emprendedores y empresas ya están usando nuestras líneas y webs para vender más y vivir más tranquilos.",
        icon: TrendingUp,
        accent: "#3b82f6",
        bg: "from-blue-900/30 via-slate-900/20 to-transparent",
        image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1000&auto=format&fit=crop",
        script: "Nuestros clientes lo confirman. Han dejado de pelear con proveedores de internet o de páginas web y ahora tienen todo en un solo lugar. Más tiempo para ellos, más crecimiento para sus negocios.",
        stats: [
            { label: "Clientes", value: "+50" },
            { label: "Satisfacción", value: "99%" },
            { label: "Estrés", value: "-80%" },
        ],
    },
    {
        id: "cta",
        tag: "MODELO",
        title: "PLANES A\nTU MEDIDA",
        subtitle: "Creces tú, crecemos nosotros.",
        body: "Cobramos a través de paquetes simples y transparentes. Tú eliges qué necesitas hoy (una línea, una web o todo el paquete) y vas escalando cuando estés listo.",
        icon: DollarSign,
        accent: "#f59e0b",
        ...
        script: "Nuestro modelo es súper sencillo: planes que se ajustan a tu bolsillo. No te obligamos a comprar lo que no necesitas. Si quieres empezar solo con tu página web, genial. Si luego necesitas más, ahí estaremos.",
        stats: [
            { label: "Planes", value: "Flexibles" },
            { label: "Cargos", value: "Transparentes" },
    ...
    },
    {
        ...
        isQRSlide: true,
        script: "Muchas gracias por escucharnos. En System Kyron estamos listos para ser el mejor aliado de tu negocio. Si quieren saber cómo podemos ayudarles hoy mismo, estoy listo para sus preguntas.",
        stats: null,
    },
];
