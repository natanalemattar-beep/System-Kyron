...
const slides = [
    ...
    },
    {
        ...
        tag: "EL DESAFÍO",
        title: "EL CAOS\nOPERATIVO",
        subtitle: "Líneas, papeles y sistemas que no se hablan.",
        body: "Los emprendedores pierden el 40% de su productividad gestionando entre 3 y 5 proveedores distintos para sus líneas telefónicas, su contabilidad y sus sistemas legales. A esto se suma el desperdicio masivo de papel y la falta de una infraestructura digital que centralice la operación.",
        icon: TriangleAlert,
        accent: "#f43f5e",
        bg: "from-rose-900/30 via-slate-900/20 to-transparent",
        image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1000&auto=format&fit=crop",
        script: "El problema real no es solo la contabilidad; es el caos. Los emprendedores gastan horas peleando con líneas telefónicas que no funcionan, proveedores que no se hablan entre sí y montañas de papel. Es una ineficiencia que cuesta tiempo, dinero y daña el planeta.",
        stats: [
            { label: "Productividad", value: "40", suffix: "% Perdida" },
            { label: "Proveedores", value: "5", suffix: "+" },
            { label: "Huella Papel", value: "Alta", suffix: "" },
        ],
    },
    {
        id: "solution",
        ...
        title: "ECOSISTEMA\nUNIFICADO",
        subtitle: "Conectividad, Automatización y Sostenibilidad.",
        body: "Kyron integra Líneas Corporativas de alta fidelidad, Contabilidad VEN-NIF automatizada y un modelo Cero Papel. Somos el puente hacia una empresa digital, eficiente y comprometida con el medio ambiente.",
        icon: Zap,
        accent: "#06b6d4",
        bg: "from-cyan-900/30 via-blue-900/20 to-transparent",
        image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=1000&auto=format&fit=crop",
        script: "System Kyron es el ecosistema definitivo. Resolvemos la conectividad con líneas corporativas inmediatas, automatizamos la gestión fiscal y eliminamos el papel. Con Kyron, tu negocio no solo es más rápido, es más inteligente y sostenible.",
        stats: [
            { label: "Conectividad", value: "5G/Voz" },
            { label: "Operación", value: "Integral" },
            { label: "Meta", value: "Zero Paper" },
        ],
        isMobileMockup: true
    },
    {
    ...
    },
    {
        ...
        tag: "IMPACTO & AMERU",
        title: "FUTURO\nSOSTENIBLE",
        subtitle: "Tecnología que cuida el planeta.",
        body: "A través de nuestra alianza con Ameru, implementamos 'Smart Bins' que incentivan el reciclaje mientras Kyron digitaliza la operación para lograr el modelo Cero Papel.",
        icon: Leaf,
        accent: "#10b981",
        bg: "from-emerald-900/30 via-slate-900/20 to-transparent",
        image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1000&auto=format&fit=crop",
        script: "Nuestro impacto es real. Con Ameru y sus Smart Bins, convertimos el reciclaje en un activo. Socialmente, formalizamos al emprendedor; ambientalmente, Kyron es el motor que elimina el papel de la oficina venezolana.",
        stats: [
            { label: "Smart Bins", value: "Ameru" },
            { label: "Modelo", value: "Cero Papel" },
            { label: "Económico", value: "Formal" },
        ],
        isMockup: true
    },
    {
