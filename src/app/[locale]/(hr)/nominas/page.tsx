            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent className="max-w-2xl bg-card border-border rounded-[2rem] p-0 overflow-hidden">
                    ...
                    <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[60vh] overflow-y-auto">
                        ...
                        <div className="space-y-2"><Label className="text-[9px] font-black uppercase tracking-widest">Cédula *</Label><Input placeholder="V-12.345.678" value={form.cedula} onChange={e => setForm(f => ({ ...f, cedula: e.target.value }))} className="h-12 rounded-xl bg-muted/30 border-border font-mono" /></div>
