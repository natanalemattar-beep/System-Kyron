  ...
  children: React.ReactNode;
    ...
    return (
      <div className="flex min-h-screen bg-background relative overflow-hidden">
          {/* Identidad Visual: Talento y Cultura */}
          <div className="absolute inset-0 pointer-events-none -z-10">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-secondary/[0.07] rounded-full blur-[120px]" />
            <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-secondary/[0.03] rounded-full blur-[100px]" />
          </div>
          ...
          <div className="flex-1 lg:pl-64 flex flex-col min-h-screen">
              ...
              >
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.015] pointer-events-none">
                    <Heart className="w-[500px] h-[500px] text-secondary" />
                  </div>
                  {children}
              </motion.main>
