        ...
        <div className="space-y-12 pb-20">
            <header className="border-l-4 border-secondary pl-8 py-2 mt-10 flex flex-col md:flex-row justify-between items-end gap-10">
                <div className="space-y-2">
                    ...
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground uppercase leading-none">Prestaciones <span className="text-secondary italic">Sociales</span></h1>
                    <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider opacity-40 mt-2 italic">Fondo de Garantía • Art. 142 LOTTT • 2026</p>
                </div>
                <div className="flex gap-2">
                    <Button variant="outline" className="h-12 px-6 rounded-xl text-[10px] font-semibold uppercase tracking-widest border-border bg-card/50 text-foreground" onClick={() => window.print()}>
            ...
            <div className="grid gap-10 lg:grid-cols-12">
                <div className="lg:col-span-4 space-y-8">
                    <Card className="glass-card border-none bg-card/40 p-10 rounded-2xl shadow-lg overflow-hidden relative group">
                        ...
                        <CardHeader className="p-0 mb-8">
                            <CardTitle className="text-sm font-semibold uppercase tracking-wider text-secondary italic">Parámetros de Cálculo</CardTitle>
                        </CardHeader>
                        <CardContent className="p-0 space-y-8 relative z-10">
                            <div className="space-y-3">
                                <Label className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/40 ml-1">Seleccionar Trabajador</Label>
                            ...
                            {emp && (
                                <div className="p-6 rounded-2xl bg-white/5 border border-border space-y-4 animate-in fade-in zoom-in-95">
                                    <div className="flex justify-between items-center text-[11px] font-bold uppercase text-muted-foreground/60">
                                    ...
                                    <div className="pt-4 border-t border-white/5 flex justify-between items-end">
                                        <p className="text-[10px] font-semibold uppercase text-secondary">Fondo Acumulado</p>
                                        <p className="text-2xl font-bold text-foreground tracking-tight">{formatCurrency(emp.fondo, 'Bs.')}</p>
                                    </div>
                                </div>
                            )}
                            <Button 
                                className="w-full h-14 rounded-2xl btn-3d-secondary font-semibold uppercase text-[10px] tracking-widest shadow-xl"
                ...
                <div className="lg:col-span-8">
                    <Card className="glass-card border-none rounded-[3.5rem] bg-card/40 overflow-hidden shadow-lg h-full flex flex-col">
                        <CardHeader className="p-10 border-b border-border/50 bg-muted/10 flex flex-row justify-between items-center">
                            <div>
                                <CardTitle className="text-sm font-semibold uppercase tracking-wider text-secondary italic">Histórico de Garantía de Prestaciones</CardTitle>
                                <CardDescription className="text-[11px] font-bold uppercase opacity-30 tracking-widest">Consolidado de depósitos trimestrales y anuales</CardDescription>
                            </div>
                            <Button variant="ghost" size="sm" className="h-9 px-4 rounded-xl text-[11px] font-semibold uppercase border border-border">
                        ...
                        <CardContent className="p-0 flex-grow flex flex-col justify-center items-center text-center px-20 opacity-20">
                            ...
                            <p className="text-[10px] font-semibold uppercase tracking-wider">Sincronizando con Bóveda de Compensación...</p>
                        </CardContent>
                        <CardFooter className="p-10 bg-secondary/5 border-t border-border flex justify-between items-center">
                            ...
                            <Badge variant="outline" className="border-secondary/20 text-secondary text-[10px] font-bold px-4 py-1.5 rounded-lg shadow-glow-sm uppercase tracking-widest">Protocolo Activo</Badge>
                        </CardFooter>
                    </Card>
                </div>
            </div>
