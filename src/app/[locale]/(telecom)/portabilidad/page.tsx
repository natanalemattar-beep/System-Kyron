"use client";
  ...
  import {Loader2, Plus, Search, Trash2, ArrowLeft, Send, Clock, CircleCheck, Smartphone, Activity} from "lucide-react";
  import { useToast } from "@/hooks/use-toast";
  import { cn } from "@/lib/utils";
  import { Link } from "@/navigation";

  interface PortabilidadSolicitud {
    id: number;
    numero: string;
  ...
  export default function PortabilidadNuméricaPage() {
    ...
    const [data, setData] = useState<PortabilidadSolicitud[]>([]);
    const [stats, setStats] = useState<PortabilidadStats>({});
    ...
    const StatIcon = { solicitadas: Send, en_proceso: Clock, completadas: CircleCheck, total: Smartphone };
      ...
      <div className="space-y-8 pb-20 relative">
        ...
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { label: "Total", val: stats.total ?? 0, icon: Smartphone, color: "text-cyan-500", glow: "shadow-cyan-500/20" }
          ].map((kpi, i) => (
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-20">
                <Smartphone className="h-16 w-16 text-muted-foreground/20 mx-auto mb-4" />
              ...
              <div className="overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {filtered.map((row: PortabilidadSolicitud) => (
