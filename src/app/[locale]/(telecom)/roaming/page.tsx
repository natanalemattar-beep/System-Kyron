"use client";
  ...
  import {Loader2, Plus, Search, Trash2, ArrowLeft, Globe, CircleCheck, Clock, DollarSign, Activity} from "lucide-react";
  import { useToast } from "@/hooks/use-toast";
  import { cn } from "@/lib/utils";
  import { Link } from "@/navigation";

  interface RoamingRegistro {
    id: number;
    numero: string;
    pais_destino: string;
    fecha_inicio: string;
    ...
    costo_diario: string;
    moneda: string;
    datos_incluidos_mb: string;
    minutos_incluidos: string;
    notas: string;
    estado: string;
  }
  ...
  export default function RoamingInternacionalPage() {
    ...
    const [data, setData] = useState<RoamingRegistro[]>([]);
    const [stats, setStats] = useState<RoamingStats>({});
            ...
            {loading ? (
              ...
              <div className="overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {filtered.map((row: RoamingRegistro) => (
