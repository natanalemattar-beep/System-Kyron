  ...
  return (
    <div className="space-y-10 px-6 md:px-10 pb-20">
      <header className="border-l-4 border-primary pl-8 py-2">
        <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-md bg-white/5 text-white/40 text-[11px] font-bold uppercase tracking-widest border border-white/5 mb-4">
            <Activity className="h-3 w-3" /> Ledger Transaccional
        </div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground uppercase leading-none italic">Registro de <span className="text-primary">Operaciones</span></h1>
      ...
      <div className="titanium-card rounded-xl overflow-hidden">
