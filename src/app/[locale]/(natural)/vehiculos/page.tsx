"use client";
  ...
  export default function MisVehículosPage() {
    ...
    const StatIcon = { total: Car, activos: CheckCircle, seguro_vencido: AlertTriangle, revision_vencida: TriangleAlert };
