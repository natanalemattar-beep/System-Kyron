...
const manualModules = [
    {
        ...
        icon: Fingerprint,
        description: "Protocolo maestro de autenticación soberana y resguardo de activos legales bajo estándares de seguridad militar.",
        content: [
            {
...
export default function ManualUsuarioPage() {
    ...
    const handleDownload = () => {
        ...
        // Header con Logo (Simulado en Word mediante tabla y estilos)
        docContent += `
        ...
        const header = "<html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:w='urn:schemas-microsoft-com:office:word' xmlns='http://www.w3.org/TR/REC-html40'><head><meta charset='utf-8'><title>Manual de Usuario System Kyron</title></head><body style='font-family: Arial, sans-serif;'>";
        const finalSource = header + docContent + footer + "</body></html>";
