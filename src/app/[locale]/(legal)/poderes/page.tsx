"use client";
  ...
  import { Loader2, Plus, Search, Trash2, ArrowLeft, CheckCircle, AlertCircle, XCircle, FileText, FileSignature, Clock, AlertTriangle, Shield, Briefcase, Scale, ShieldCheck, Activity, Wallet, Users, DollarSign, Car, Heart, Phone, Globe, Package, Building, UserCheck, Receipt, ShoppingCart, CreditCard, Stethoscope, ShieldAlert, Smartphone, MapPin, Star, Send, Eye, Calendar, Hash, Landmark } from "lucide-react";
  ...
  export default function PoderesNotariadosPage() {
    ...
    const StatIcon = { vigentes: CheckCircle, vencidos: AlertCircle, revocados: XCircle, total: FileText };
      ...
      <div className="space-y-8 pb-20 relative">
        ...
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { label: "Vencidos", val: stats.vencidos ?? 0, icon: AlertCircle, color: "text-rose-500", glow: "shadow-rose-500/20" },
