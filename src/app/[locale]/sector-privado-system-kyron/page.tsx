                ...
                <div id="zedu-document-content">
                    ...
                    <div className="mb-20">
                        ...
                        <table className="w-full border-collapse">
                            ...
                            <tbody>
                                <tr>
                                    <td className={tableCellClass}>Suscripción API Anthropic Claude (IA generativa para módulos legales, fiscal y eco-créditos) — plan anual</td>
                                    <td className={cn(tableCellClass, "text-center")}>1</td>
                                    <td className={cn(tableCellClass, "text-right font-black")}>$ 480,00</td>
                                    <td className={tableCellClass}>Anthropic Console (en línea)</td>
                                </tr>
                                <tr>
                        ...
                        <table className="w-full border-collapse">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className={tableCellClass}>Acceso a créditos de Anthropic y la API de Claude bajo el programa educativo. Documentación técnica, recursos de formación en inteligencia artificial y soporte en la arquitectura de sistemas basados en IA generativa para equipos estudiantiles emprendedores.</td>
                                </tr>
                                <tr>
                    ...
                    <div className="mb-20">
                        ...
                        <table className="w-full border-collapse">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className={tableCellClass}><strong>6.</strong> Integración de IA Claude: implementación de generación de contratos, análisis fiscal predictivo, clasificación de residuos para eco-créditos y asistente de documentos legales con IA.</td>
                                    <td className={cn(tableCellClass, "text-center font-black")}>Miguel Angel Goites</td>
                        ...
                        <table className="w-full border-collapse">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className={tableCellClass}>
                                        <p>Tour interactivo de los 12 portales directamente desde la página web, sin necesidad de crear una cuenta. El visitante puede explorar la interfaz del módulo contable VEN-NIF, ver un ejemplo de nómina LOTTT calculada en tiempo real, probar el generador de contratos con IA Claude y consultar la tasa BCV actualizada. Conversión estimada: 15% de visitantes que completan el tour se registran como usuarios.</p>
                                    </td>
                                </tr>
                                <tr>
