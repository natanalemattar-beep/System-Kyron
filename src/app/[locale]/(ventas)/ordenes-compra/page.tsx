"use client";
  ...
  import { Loader2, Plus, Search, Trash2, ArrowLeft, ShoppingCart, Clock, CheckCircle, DollarSign, TriangleAlert, XCircle, AlertTriangle, FileText, Shield, Briefcase, Scale, ShieldCheck, FileSignature, Activity, Wallet, Users, Car, Heart, Phone, Globe, Package, Building, UserCheck, Receipt, CreditCard, Stethoscope, ShieldAlert, Smartphone, MapPin, Star, Send, Eye, Calendar, Hash, Landmark } from "lucide-react";
