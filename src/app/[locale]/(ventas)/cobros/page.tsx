"use client";
  ...
  import { Loader2, Plus, Search, Trash2, ArrowLeft, CreditCard, Clock, CheckCircle, DollarSign, AlertCircle, XCircle, AlertTriangle, FileText, Shield, Briefcase, Scale, ShieldCheck, FileSignature, Activity, Wallet, Users, Car, Heart, Phone, Globe, Package, Building, UserCheck, Receipt, ShoppingCart, Stethoscope, ShieldAlert, Smartphone, MapPin, Star, Send, Eye, Calendar, Hash, Landmark } from "lucide-react";
  ...
  export default function GestióndeCobrosPage() {
    ...
    const StatIcon = { total: CreditCard, pendientes: Clock, cobrados: CheckCircle, saldo_total: DollarSign };
      ...
      <div className="space-y-8 pb-20 relative">
        ...
        <div>
          ...
          <motion.header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div>
              ...
              <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-[0.4em] opacity-40 mt-2">Control de Cuentas por Cobrar y Mora</p>
            </div>
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle className="text-xl font-black uppercase">Nuevo — Gestión de Cobros</DialogTitle>
                </DialogHeader>
        ...
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { label: "Cobrados", val: stats.cobrados ?? 0, icon: CheckCircle, color: "text-emerald-500", glow: "shadow-emerald-500/20" },
            ...
            {loading ? (
              ...
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                        <TableHead className="text-[10px] font-black uppercase tracking-wider text-muted-foreground">Factura Ref.</TableHead>
                      <TableHead className="text-[10px] font-black uppercase tracking-wider text-muted-foreground">Cliente</TableHead>
                      <TableHead className="text-[10px] font-black uppercase tracking-wider text-muted-foreground">Monto Original</TableHead>
                      <TableHead className="text-[10px] font-black uppercase tracking-wider text-muted-foreground">Saldo Pend.</TableHead>
