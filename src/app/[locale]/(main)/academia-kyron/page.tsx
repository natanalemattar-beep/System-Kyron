    ...
    return (
        <div className="space-y-12 w-full px-6 md:px-16 pb-20">
            <header className="border-l-4 border-yellow-500 pl-8 py-2 mt-10">
                ...
                <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic text-white italic-shadow">Kyron <span className="text-yellow-500">Academy</span></h1>
            ...
            <Card className="bg-gradient-to-br from-yellow-500 to-amber-600 border-none rounded-[3rem] p-12 relative overflow-hidden shadow-glow">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
                    <div className="space-y-6">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black uppercase italic tracking-tighter text-white italic-shadow">Conviértete en un Operador Maestro</h2>
