...
export default function ModeloZEDUPage() {
    ...
    const budgetData = [
      ...
      { item: "Capacitación & Marketing", cost: 2350, cat: "Lanzamiento" },
    ];
    ...
    const handleDownloadWord = () => {
        const content = `
            <h1 style="text-align: center;">MODELO ZEDU - SYSTEM KYRON</h1>
            <h2 style="color: #2563eb;">Telecomunicaciones como Eje Central + Automatización Fiscal y Reciclaje</h2>
            ...
            <p><b>Ubicación:</b> La Atlántida, Catia La Mar, La Guaira.</p>
            ...
            <p>Conectividad deficiente y fragmentación de servicios. Pérdida de archivos escolares por clima.</p>

            <h3>4. SOLUCIÓN PROPUESTA</h3>
            <p>Ecosistema integral liderado por telecomunicaciones (Línea 5G/eSIM) + Automatización IA y Reciclaje Magnético.</p>

            <h3>5. PRESUPUESTO TÉCNICO</h3>
            <p><b>Inversión Total:</b> ${formatCurrency(totalBudget, 'USD')}</p>
            <p>Incluye Moto Bera Carguera DT-200 para distribución litoral.</p>
            
            <h3>7. PLAN DE ACCIÓN JERÁRQUICO</h3>
            <p><b>Liderazgo:</b> Carlos Mattar (Estrategia e IA). Apoyo: Sebastian y Marcos (Operaciones).</p>
        `;
        ...
        <div className="space-y-16 w-full animate-in fade-in duration-1000 pb-32">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 w-full">
                ...
                <div className="xl:col-span-7 space-y-12">
                        ...
                        <Card className="glass-card border-none p-10 leading-relaxed shadow-2xl rounded-[2.5rem] relative overflow-hidden">
                            ...
                            <div className="space-y-6">
                                <p className="text-lg font-bold text-white/90 italic text-justify leading-relaxed">
                                    La comunidad de La Guaira carece de un proveedor único que ofrezca **conectividad confiable**, integrando además servicios de automatización fiscal y reciclaje inteligente. La alta humedad deteriora archivos físicos críticos en instituciones como el Colegio Gabriela Mistral.
                                </p>
                                <div className="grid grid-cols-2 gap-4">
                                    <Badge variant="outline" className="text-[9px] border-primary/20 text-primary py-2 px-4 uppercase">☑️ Tecnológico</Badge>
                                    <Badge variant="outline" className="text-[9px] border-primary/20 text-primary py-2 px-4 uppercase">☑️ Ambiental</Badge>
                                    <Badge variant="outline" className="text-[9px] border-primary/20 text-primary py-2 px-4 uppercase">☑️ Educativo</Badge>
                    ...
                    <section>
                        <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-primary mb-6 flex items-center gap-3"><Zap className="h-4 w-4" /> 4. Solución: Telecomunicaciones 5G</h3>
                        <Card className="glass-card border-none p-10 leading-relaxed shadow-2xl relative overflow-hidden rounded-[2.5rem]">
                            ...
                            <p className="text-lg font-bold text-white/90 italic text-justify leading-relaxed">
                                **System Kyron** es un ecosistema cuya columna vertebral son las telecomunicaciones. Ofrecemos **Líneas 5G (SIM/eSIM)** y venta de equipos homologados. Sobre esta base de conectividad, integramos módulos de IA para gestión fiscal, digitalización escolar a prueba de humedad y reciclaje magnético con incentivos digitales.
                            </p>
                        </Card>
                    </section>
                    ...
                    <section>
                        <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-primary mb-6 flex items-center gap-3"><Smartphone className="h-4 w-4" /> 7. Plan de Acción Jerárquico</h3>
                        <Card className="glass-card border-none overflow-hidden shadow-2xl rounded-[2.5rem]">
                            <CardContent className="p-0">
                                <div className="p-8 border-b border-white/5 bg-primary/[0.03]">
                                    ...
                                    <p className="text-xs text-white/60 font-medium">Arquitectura de Red, IA, Blockchain y Permisos CONATEL.</p>
                                </div>
                                <div className="p-8">
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-center gap-3 text-xs font-bold text-white/70 italic"><CheckCircle className="h-4 w-4 text-primary opacity-40"/> Digitalización de Archivos Colegio Gabriela Mistral</li>
                                        ...
                                        <li className="flex items-center gap-3 text-xs font-bold text-white/70 italic"><CheckCircle className="h-4 w-4 text-primary opacity-40"/> Instalación de Puntos de Reciclaje Magnético</li>
                                    </ul>
                                </div>
                            </CardContent>
                        </Card>
