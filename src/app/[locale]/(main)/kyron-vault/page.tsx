        ...
        <div className="space-y-12 w-full animate-in fade-in duration-1000 pb-20 px-4 md:px-10">
            <header className="flex flex-col md:flex-row justify-between items-end gap-10 border-l-8 border-primary pl-10 py-2">
                <div className="space-y-2">
                    <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-[9px] font-black uppercase tracking-[0.4em] text-primary mb-2">
            ...
            <Tabs defaultValue="zedu" className="w-full">
                <TabsList className="grid w-full grid-cols-3 h-14 bg-white/[0.02] border border-white/5 rounded-2xl p-1.5 mb-12">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                        ...
                        <div className="xl:col-span-8 space-y-10">
                            <Card className="glass-card border-none p-12 rounded-[2.5rem]">
                                <h3 className="text-xl font-black italic uppercase text-primary mb-6">Análisis del Problema</h3>
                            ...
                            <Card className="glass-card border-none overflow-hidden rounded-[2.5rem]">
                                <Table>
                                    <TableHeader><TableRow className="bg-white/5 border-none"><TableHead className="pl-10 py-5 font-black uppercase text-primary text-[9px]">Componente</TableHead><TableHead className="text-right pr-10 py-5 font-black uppercase text-primary text-[9px]">Inversión</TableHead></TableRow></TableHeader>
                                    <TableBody>
                                        {budgetData.map((d, i) => (
                                            <TableRow key={i} className="border-white/5 hover:bg-primary/5"><TableCell className="pl-10 py-3.5 text-xs font-bold text-white/70">{d.item}</TableCell><TableCell className="text-right pr-10 font-black italic text-primary text-sm">{formatCurrency(d.cost, 'USD')}</TableCell></TableRow>
                                        ))}
                ...
                <TabsContent value="factibilidad">
                    ...
                    <Card className="bg-primary p-12 rounded-[3rem] relative overflow-hidden">
                ...
                <TabsContent value="propuesta">
                    <Card className="glass-card border-none p-16 rounded-[3rem] max-w-5xl mx-auto">
                        ...
                        <div className="space-y-8 text-white/80 leading-relaxed text-justify text-sm">
                            <p className="text-base font-bold italic">Estimados Aliados,</p>
                            ...
                            <div className="grid md:grid-cols-2 gap-6 py-8">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                    <h4 className="text-primary font-black uppercase text-[10px] mb-3">Pilar 1: Infraestructura</h4>
                                    <p className="text-xs font-medium">Despliegue de red mayorista y asignación masiva de eSIMs para garantizar el flujo de datos.</p>
                                </div>
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                                    <h4 className="text-primary font-black uppercase text-[10px] mb-3">Pilar 2: Inteligencia</h4>
                                    <p className="text-xs font-medium">Blindaje total ante entes reguladores mediante el motor de auditoría continua IA.</p>
                                </div>
                            </div>
