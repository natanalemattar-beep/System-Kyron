...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-10 md:space-y-16 w-full animate-in fade-in duration-1000 px-4 md:px-10 pb-20">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-10 border-l-4 border-primary pl-4 md:pl-8 py-2">
        <div className="space-y-2">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tighter uppercase italic leading-none text-white italic-shadow">Centro de Mando</h1>
        ...
        <div className="flex gap-4">
            <div className="px-4 py-2 rounded-xl bg-white/[0.02] border border-white/5 backdrop-blur-xl flex items-center gap-3">
                ...
                <div className="text-left">
                    ...
                    <p className="text-[9px] font-bold text-white leading-none uppercase">Optimal</p>
                </div>
            </div>
        </div>
      </header>
      ...
      <div className="space-y-10">
        ...
        <div className="grid gap-6 md:gap-8 grid-cols-1 lg:grid-cols-12">
            <Card className="lg:col-span-4 bg-primary text-primary-foreground rounded-[1.5rem] md:rounded-[2rem] overflow-hidden relative group p-1 shadow-2xl border-none">
                ...
                <div className="p-6 md:p-8 space-y-4 md:space-y-6 relative z-10 bg-primary rounded-[1.4rem] md:rounded-[1.9rem] h-full flex flex-col justify-between min-h-[240px]">
                    <div className="space-y-1">
                        <CardTitle className="text-xl md:text-2xl font-black uppercase italic tracking-tighter leading-tight">Bóveda Kyron</CardTitle>
                    ...
                    <div className="space-y-4">
                        ...
                        <Button variant="secondary" asChild className="w-full h-10 text-[8px] md:text-[9px] font-black bg-white text-primary hover:bg-white/90 rounded-xl uppercase tracking-widest transition-all">
                            <Link href="/sector-privado-system-kyron" className="flex justify-between w-full px-3 md:px-4">
                                <span>ENTRAR AL SECTOR PRIVADO</span> 
