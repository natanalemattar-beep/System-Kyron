...
const RESOURCES = [
    {
        ...
        description: 'Pitch Deck interactivo de alta fidelidad con arquitectura tecnológica y visión 2026.',
        icon: Presentation,
    ...
    },
    {
        ...
        description: 'Síntesis técnica de 2 páginas con modelo SaaS y blindaje Kyron Shield.',
        icon: FileText,
    ...
    },
    {
        ...
        description: 'Script oficial de 4:30 minutos optimizado para una locución autoritaria.',
        icon: Mic,
        href: '/guion-defensa',
    ...
    },
    {
        ...
        description: 'Stickers, Marca Libros y Tarjetas de Presentación listos para impresión.',
        icon: ImageIcon,
        href: '/stickers',
    ...
    {
        id: 'cartas',
        title: 'Cartas de Alianza',
        description: 'Correspondencia oficial para aliados estratégicos de primer nivel.',
        icon: Building2,
        href: '/cartas',
    ...
    },
    {
        ...
        description: 'Presencia digital y catálogo visual de innovaciones corporativas.',
        icon: Instagram,
    ...
    },
    {
        id: 'paisaje',
        title: 'Venezuela 4K',
        description: 'Toma cinematográfica del Salto Ángel para entornos inmersivos.',
        icon: Globe,
