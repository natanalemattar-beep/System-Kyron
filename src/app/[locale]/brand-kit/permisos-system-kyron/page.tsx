    ...
    <div className="min-h-screen bg-[#020617] text-white font-[family-name:var(--font-outfit)] selection:bg-cyan-500/30">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-24">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.15 }} className="space-y-3">
          {permisos.map((p, i) => (
            <div key={i} className="group rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:border-white/20 transition-all duration-500 p-6">
              <h3 className="text-lg font-black tracking-tight text-white group-hover:text-cyan-200 transition-colors mb-1">{p.permiso}</h3>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="mt-16 p-5 rounded-2xl bg-cyan-500/5 border border-cyan-500/10">
