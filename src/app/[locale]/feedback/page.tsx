...
const QUESTIONS = [
    ...
    {
        id: "team_size",
        label: "Especifique el número aproximado de colaboradores en su nómina:",
        type: "choice" as const,
        options: ["1 - 10 empleados", "11 - 50 empleados", "51 - 200 empleados", "Más de 200 empleados"],
    },
    {
        id: "tech_investment",
        label: "Seleccione el rango de inversión mensual estimado en servicios tecnológicos:",
        type: "choice" as const,
        options: ["Menos de $100", "$100 - $500", "$500 - $2000", "Superior a $2000"],
    },
    {
        id: "fiscal_satisfaction",
        label: "Valore el nivel de complejidad que representa para su empresa el cumplimiento fiscal y parafiscal:",
        type: "rating" as const,
    },
    {
        id: "digital_needs",
        label: "Identifique el área con mayor prioridad de optimización tecnológica:",
        type: "choice" as const,
        options: ["Facturación & Cumplimiento Fiscal", "Gestión de Recursos Humanos", "Telecomunicaciones Corporativas", "Asesoría Legal Automatizada", "Inteligencia de Negocios"],
    },
    {
        id: "contact",
        label: "Suministre un medio de contacto para recibir una propuesta corporativa personalizada:",
        type: "text" as const,
