...
function FakeInput({ label, value, icon: Icon, highlight }: { label: string; value: string; icon?: React.ElementType; highlight?: boolean }) {
    return (
        <div className="space-y-1.5">
            ...
            <div className={cn(
                "flex items-center gap-2.5 h-10 px-3 rounded-lg border bg-white/[0.03] transition-all",
                highlight ? "border-sky-500/40 ring-1 ring-sky-500/20" : "border-white/[0.08]"
            )}>
                {Icon && <Icon className="h-3.5 w-3.5 text-white/25 shrink-0" />}
    ...
    return [
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-sm text-white/50 leading-relaxed">
                        Al ingresar a <span className="text-white/70 font-medium">/register</span>, verás un campo donde seleccionas el tipo de documento. Cada prefijo muestra módulos diferentes:
                    </p>
                    <div className="grid grid-cols-1 gap-2">
                        {[
                            ...
                            <div key={p.prefix} className="flex items-center gap-3 p-3 rounded-lg border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-colors">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[10px] text-white/25 mt-0.5">{p.modules}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <FakeCard className="border-sky-500/15">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-white/80">Documento de identidad</p>
                                <p className="text-[10px] text-white/30">Cédula de identidad</p>
                            </div>
                        </div>
                        <div className="flex gap-2 mb-3">
                            ...
                            <div className="flex-1 h-10 px-3 rounded-lg border border-sky-500/30 bg-sky-500/5 flex items-center">
                                <span className="text-sm font-semibold text-white/70 tracking-wider">00000000</span>
                                <span className="ml-auto text-[9px] text-white/20 font-semibold">CI</span>
                            </div>
                        </div>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-sm text-white/50 leading-relaxed">
                        Para una <span className="text-emerald-400 font-semibold">empresa o persona jurídica</span>, selecciona "J" e ingresa el RIF en formato <span className="text-white/70 font-mono">12345678-9</span>.
                    </p>
                    <FakeCard className="border-emerald-500/15">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-white/80">Documento de identidad</p>
                                <p className="text-[10px] text-white/30">RIF empresarial</p>
                            </div>
                        </div>
                        <div className="flex gap-2 mb-3">
                            ...
                            <div className="flex-1 h-10 px-3 rounded-lg border border-emerald-500/30 bg-emerald-500/5 flex items-center">
                                <span className="text-sm font-semibold text-white/70 tracking-wider">00000000-0</span>
                                <span className="ml-auto text-[9px] text-white/20 font-semibold">RIF</span>
                            </div>
                            <div className="flex items-center gap-1 h-10 px-3 rounded-lg border border-white/[0.08] bg-white/[0.03]">
                                <span className="text-[10px] font-semibold text-white/40">Buscar</span>
                            </div>
                        </div>
                        <div className="flex items-center gap-2 p-2.5 rounded-lg border border-emerald-500/15 bg-emerald-500/[0.03]">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-white/25">Persona Jurídica · {FAKE_DATA.estado}</p>
                            </div>
                        </div>
                    </FakeCard>
                    <p className="text-[11px] text-white/30 px-1">
                        El botón <span className="font-semibold text-white/40">"Buscar"</span> consulta el RIF en SENIAT para autocompletar los datos de la empresa.
                    </p>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-sm text-white/50 leading-relaxed">
                        Después de verificar tu documento, el sistema muestra los <span className="text-white/70 font-semibold">portales disponibles</span> según tu tipo de identificación.
                    </p>
                    <p className="text-xs text-white/30">Ejemplo: Módulos para <span className="text-emerald-400 font-semibold">Persona Jurídica (J)</span></p>
                    <div className="space-y-2">
                        {[
                            ...
                            <div key={m.title} className="flex items-center gap-3 p-3 rounded-lg border border-white/[0.06] bg-white/[0.02]">
                                <div className={cn("w-9 h-9 rounded-lg flex items-center justify-center shrink-0", m.bg)}>
                                    <m.icon className={cn("h-4 w-4", m.color)} />
                                </div>
                                <div className="flex-1 min-w-0">
                                    <p className="text-xs font-semibold text-white/70">{m.title}</p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[
                            ...
                            <div key={p.name} className={cn("p-3 rounded-lg border bg-white/[0.02] text-center", p.border)}>
                                <p className={cn("text-xs font-semibold", p.color)}>{p.name}</p>
                                <p className="text-sm font-bold text-white/70 mt-1">{p.price}</p>
                            </div>
                        ))}
                    </div>
                </div>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    <FakeCard>
                        <p className="text-[10px] font-semibold text-white/30 uppercase tracking-wider mb-3">Datos de la empresa</p>
                    ...
                    <FakeCard>
                        <p className="text-[10px] font-semibold text-white/30 uppercase tracking-wider mb-3">Contacto</p>
                        <div className="grid grid-cols-2 gap-3">
                    ...
                    <FakeCard>
                        <p className="text-[10px] font-semibold text-white/30 uppercase tracking-wider mb-3">Ubicación</p>
                        <div className="grid grid-cols-2 gap-3">
            ...
            content: (
                <div className="space-y-5">
                    <div className="flex flex-col items-center text-center py-4">
                        ...
                        <p className="text-lg font-bold text-white mb-2">Registro completado</p>
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button asChild variant="outline" className="h-10 rounded-lg border-white/[0.08] bg-white/[0.03] text-white/50 hover:text-white/70 hover:bg-white/[0.06] text-sm">
                ...
                <div className="flex-1 flex flex-col items-center px-4 pb-10">
                    <div className="w-full max-w-lg">
                        <div className="text-center mb-6">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.04] border border-white/[0.06] mb-4">
                        ...
                        <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] backdrop-blur-sm overflow-hidden">
                            <div className="p-5 border-b border-white/[0.04]">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-[11px] text-white/30">{step.subtitle}</p>
                                    </div>
                                    <span className="text-[10px] font-semibold text-white/20 shrink-0">
                            ...
                            <div className="p-4 border-t border-white/[0.04] flex items-center justify-between">
                                <Button
                                    ...
                                    className="h-9 px-4 rounded-lg border-white/[0.08] bg-white/[0.03] text-white/50 hover:text-white/70 hover:bg-white/[0.06] text-xs font-medium disabled:opacity-20"
                                >
