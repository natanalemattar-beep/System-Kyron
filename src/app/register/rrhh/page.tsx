...
export default function RegisterRrhhPage() {
    const registerProps = {
        ...
        description: "Crea tu cuenta de Recursos Humanos.",
        fields: [
            { id: "username", label: "Usuario", type: "text" as const, placeholder: "usuario.rrhh", required: true, defaultValue: "usuario.rrhh" },
            { id: "email", label: "Correo Electrónico Corporativo", type: "email" as const, placeholder: "rrhh@tuempresa.com", required: true },
