    ...
    return (
        <Card className="w-full max-w-md mx-auto bg-card/80 backdrop-blur-md border">
            <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Registro de RR.HH.</CardTitle>
                <CardDescription>Crea tu cuenta para el portal de Recursos Humanos.</CardDescription>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
                 <div className="space-y-2">
                    <Label htmlFor="employee-id">ID de Empleado</Label>
                    <Input id="employee-id" placeholder="rrhh.user" required />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="email">Correo Electrónico Corporativo</Label>
                    <Input id="email" type="email" placeholder="rrhh@tuempresa.com" required />
                </div>
                ...
                <Button type="submit" className="w-full h-11 text-base">Crear Cuenta de RR.HH.</Button>
            </CardContent>
            <CardFooter className="flex-col p-6 border-t text-sm">
                 <p className="text-muted-foreground">¿Ya tienes una cuenta?</p>
                <Link href="/login-rrhh" className="font-medium text-primary hover:underline">
                    Inicia sesión aquí
                </Link>
            </CardFooter>
        </Card>
