    ...
    return (
        <Card className="w-full max-w-md mx-auto bg-card/80 backdrop-blur-md border">
            <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Registro de Telecomunicaciones</CardTitle>
                <CardDescription>Crea tu cuenta para el portal de gestión de redes.</CardDescription>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
                 <div className="space-y-2">
                    <Label htmlFor="employee-id">ID de Empleado / Usuario</Label>
                    <Input id="employee-id" placeholder="telecom.user" required />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="email">Correo Electrónico Corporativo</Label>
                    <Input id="email" type="email" placeholder="telecom@tuempresa.com" required />
                </div>
            ...
            <CardFooter className="flex-col p-6 border-t text-sm">
                ...
                <Link href="/login-telecom" className="font-medium text-primary hover:underline">
                    Inicia sesión aquí
                </Link>
            </CardFooter>
        </Card>
