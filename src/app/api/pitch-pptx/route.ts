...
function bg(slide: pptxgen.Slide, variant: 'dark' | 'navy' | 'close' = 'dark') {
  if (variant === 'close') {
    ...
    slide.addShape('rect', { x: 0, y: 0, w: W, h: 0.18, fill: { color: C.blue }, line: { color: C.blue } });
    slide.addShape('rect', { x: 0, y: H - 0.18, w: W, h: 0.18, fill: { color: C.green }, line: { color: C.green } });
  } else if (variant === 'navy') {
    slide.addShape('rect', { x: 0, y: 0, w: W, h: H, fill: { color: C.navyLight }, line: { color: C.navyLight } });
    slide.addShape('rect', { x: 0, y: 0, w: 0.12, h: H, fill: { color: C.blue }, line: { color: C.blue } });
  } else {
    slide.addShape('rect', { x: 0, y: 0, w: W, h: H, fill: { color: C.navy }, line: { color: C.navy } });
    slide.addShape('rect', { x: 0, y: 0, w: 0.12, h: H, fill: { color: C.blue }, line: { color: C.blue } });
  }
...
function footer(slide: pptxgen.Slide, num: number, total: number, seg: string, seccion: string) {
  slide.addShape('rect', { x: 0, y: H - 0.48, w: W, h: 0.48, fill: { color: C.navyCard }, line: { color: C.navyCard } });
  slide.addShape('rect', { x: 0, y: H - 0.49, w: W, h: 0.02, fill: { color: C.grayDark }, line: { color: C.grayDark } });
  ...
  slide.addShape('rect', { x: 10.0, y: H - 0.44, w: 3.1, h: 0.38, fill: { color: C.blue + '20' }, line: { color: C.blue, pt: 0.75 }, rounding: true });
...
function header(slide: pptxgen.Slide, tag: string, title: string, color = C.blue) {
  ...
  slide.addShape('rect', { x: 0.4, y: 1.5, w: 1.6, h: 0.055, fill: { color }, line: { color } });
}

function card(slide: pptxgen.Slide, x: number, y: number, w: number, h: number, border = C.blue) {
  slide.addShape('rect', { x, y, w, h, fill: { color: C.navyCard }, line: { color: border, pt: 1 }, rounding: true });
}
...
export async function GET() {
  try {
    ...
    // ─── SLIDE 1 · PORTADA · 10 seg ──────────────────────────────────────────
    {
      ...
      s.addShape('rect', { x: 0, y: 0, w: W, h: H, fill: { color: C.navy }, line: { color: C.navy } });
      s.addShape('rect', { x: 0, y: 0, w: 4.6, h: H, fill: { color: C.navyCard }, line: { color: C.navyCard } });
      s.addShape('rect', { x: 4.6, y: 0, w: 0.07, h: H, fill: { color: C.blue }, line: { color: C.blue } });
      s.addShape('rect', { x: 0, y: 0, w: 4.6, h: 0.12, fill: { color: C.blue }, line: { color: C.blue } });
      s.addShape('rect', { x: 0, y: H - 0.12, w: 4.6, h: 0.12, fill: { color: C.green }, line: { color: C.green } });

      s.addShape('hexagon', { x: 0.8, y: 1.3, w: 3.0, h: 3.0, fill: { color: C.blue + '18' }, line: { color: C.blue, pt: 2 } });
      ...
      s.addShape('rect', { x: 5.0, y: 4.28, w: 1.8, h: 0.055, fill: { color: C.green }, line: { color: C.green } });
      ...
      s.addShape('rect', { x: 5.0, y: 5.7, w: 3.6, h: 0.72, fill: { color: C.blue }, line: { color: C.blue }, rounding: true });
    ...
    // ─── SLIDE 2 · GANCHO · 30 seg ───────────────────────────────────────────
    {
      ...
      s.addShape('rect', { x: 3.5, y: 3.55, w: 6.3, h: 0.055, fill: { color: C.gold }, line: { color: C.gold } });
    ...
    // ─── SLIDE 3 · EL PROBLEMA · 45 seg ─────────────────────────────────────
    {
      ...
      puntos.forEach((p, i) => {
        ...
        s.addShape('rect', { x: 0.3, y, w: 1.5, h: 0.72, fill: { color: col + '20' }, line: { color: col, pt: 1 }, rounding: true });
    ...
    // ─── SLIDE 4 · LA SOLUCIÓN · 45 seg ─────────────────────────────────────
    {
      ...
      mods.forEach((m, i) => {
        ...
        s.addShape('rect', { x, y, w: 4.08, h: 0.08, fill: { color: border }, line: { color: border } });
    ...
    // ─── SLIDE 5 · INNOVACIONES CLAVE · 30 seg ───────────────────────────────
    {
      ...
      invs.forEach((inv, i) => {
        const y = 1.72 + i * 1.3;
        s.addShape('rect', { x: 0.3, y, w: 0.9, h: 0.88, fill: { color: inv.col + '22' }, line: { color: inv.col, pt: 1.5 }, rounding: true });
        ...
        if (i < invs.length - 1)
          s.addShape('rect', { x: 0.3, y: y + 1.15, w: 12.75, h: 0.01, fill: { color: C.grayDark }, line: { color: C.grayDark } });
      });
    ...
    // ─── SLIDE 6 · TRACCIÓN · 40 seg ─────────────────────────────────────────
    {
      ...
      [
        ...
        s.addShape('rect', { x, y: y + 0.1, w: 0.18, h: 0.18, fill: { color: C.green }, line: { color: C.green }, rounding: true });
    ...
    // ─── SLIDE 7 · MERCADO & MODELO · 35 seg ─────────────────────────────────
    {
      ...
      datos.forEach((d, i) => {
        const y = 1.68 + i * 1.3;
        s.addShape('rect', { x: 0.3, y: y + 0.25, w: d.bw, h: 0.55, fill: { color: d.col + '28' }, line: { color: d.col, pt: 1 } });
      ...
      s.addShape('rect', { x: 0.3, y: 5.65, w: 12.75, h: 0.9, fill: { color: C.navyCard }, line: { color: C.blue, pt: 1 }, rounding: true });
    ...
    // ─── SLIDE 8 · EL EQUIPO · 25 seg ────────────────────────────────────────
    {
      ...
      mbs.forEach((m, i) => {
        ...
        s.addShape('rect', { x, y, w: 6.2, h: 0.1, fill: { color: m.col }, line: { color: m.col } });
        s.addShape('ellipse', { x: x + 0.22, y: y + 0.28, w: 1.0, h: 1.0, fill: { color: m.col + '28' }, line: { color: m.col, pt: 1.5 } });
    ...
    // ─── SLIDE 9 · RONDA SEED · 25 seg ───────────────────────────────────────
    {
      ...
      usos.forEach((u, i) => {
        const y = 1.68 + i * 1.34;
        s.addShape('rect', { x: 0.3, y, w: 1.5, h: 1.1, fill: { color: u.col + '1E' }, line: { color: u.col, pt: 1.5 }, rounding: true });
        ...
        s.addShape('rect', { x: 2.0, y: y + 0.55, w: u.bw, h: 0.15, fill: { color: u.col }, line: { color: u.col }, rounding: true });
        s.addShape('rect', { x: 2.0 + u.bw, y: y + 0.55, w: 11.0 - u.bw, h: 0.15, fill: { color: u.col + '25' }, line: { color: u.col + '25' }, rounding: true });
    ...
    // ─── SLIDE 10 · CIERRE · 15 seg ──────────────────────────────────────────
    {
      const s = pptx.addSlide();
      bg(s, 'close');
      s.addShape('hexagon', { x: 4.5, y: 0.3, w: 4.3, h: 4.3, fill: { color: C.blue + '12' }, line: { color: C.blue + '45', pt: 2 } });
      ...
      s.addShape('rect', { x: 3.4, y: 3.7, w: 6.53, h: 0.82, fill: { color: C.blue }, line: { color: C.blue }, rounding: true });
