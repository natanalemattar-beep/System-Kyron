...
import { Gavel, FileSignature, BookOpen, Clock, ArrowRight, TrendingUp, Wallet, ShieldCheck, Percent, FileText, FilePlus, Users, Landmark, ShieldAlert } from "lucide-react";
...
const kpiData = [
  { title: "Ingresos del Mes", value: formatCurrency(62000, 'Bs.'), icon: TrendingUp, trend: "+12.7% vs mes anterior", trendColor: "text-green-500" },
