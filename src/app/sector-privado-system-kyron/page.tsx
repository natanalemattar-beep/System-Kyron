...
const zeduMasterData = {
    ...
    secciones: [
        ...
        {
            id: 3,
            titulo: "3. DIAGNÓSTICO OPERATIVO",
            filas: [
                { label: "Brecha Detectada", val: "Desconexión entre registros fiscales y flujos de caja." },
                { label: "Mejora Estimada", val: "Aumento del 40% en eficiencia administrativa." },
                { label: "Prevención de Riesgo", val: "Eliminación de sanciones por desactualización legal." },
            ]
        },
        {
            id: 4,
            titulo: "4. SOLUCIÓN INTEGRAL",
            filas: [
                { label: "Inteligencia Artificial", val: "Motor de Validación Fiscal" },
                { label: "Seguridad", val: "Blockchain para Registros Inmutables" },
                { label: "Conectividad", val: "Red de Datos 5G Privada" },
            ]
        }
    ]
};
...
const indicators = [
    { label: "Rentabilidad Proyectada", value: 450000, icon: TrendingUp },
    { label: "Rendimiento Anual", value: 0.285, icon: Target },
    ...
    const handleDownloadExpediente = () => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                const header = `
                    ...
                    <body>
                        <div class="header">
                            ...
                            <div class="id-code">EXPEDIENTE ESTRATÉGICO • REF: MASTER-2026-X1</div>
                        </div>
                        <h1 style="text-align:center; font-size: 18pt; margin-bottom: 30px;">Dossier Maestro de Implementación</h1>
                `;
                ...
                body += `
                    <div class="dictamen">
                        <div class="dictamen-title">Dictamen de Viabilidad Profesional</div>
                        <p style="font-style: italic; color: #0c4a6e;">"Tras el análisis exhaustivo de los parámetros operativos y la arquitectura propuesta, se dictamina una viabilidad absoluta para el despliegue del ecosistema System Kyron. La integración de inteligencia fiscal y el registro inmutable garantizan una escalabilidad superior, eliminando los riesgos de cumplimiento normativo para el sector privado."</p>
                    </div>
                `;

                const footer = `<div class="footer">Documento Generado por System Kyron • 2026 • Privado y Confidencial</div></body></html>`;
                ...
                fileDownload.download = `EXPEDIENTE_ZEDU_KYRON_PRO.doc`;
                fileDownload.click();
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 border-l-4 border-primary pl-6 md:pl-10 py-4 mt-10 relative z-10 no-print">
                <div className="space-y-3">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-primary/10 border border-primary/20 text-[9px] font-black uppercase tracking-[0.4em] text-primary shadow-glow">
                        <Terminal className="h-3 w-3" /> ARCHIVO CORPORATIVO
                    </div>
                ...
                <div className="flex w-full md:w-auto gap-3">
                    ...
                    >
                        ...
                        {isVerifying ? "PROCESANDO..." : "DESCARGAR EXPEDIENTE"}
                    </Button>
                </div>
            </header>
                    ...
                    <Card className="glass-card border-none rounded-[3rem] bg-white/[0.01] overflow-hidden shadow-2xl relative">
                            ...
                            {showSeal && (
                                ...
                                >
                                    <div className="p-12 border-8 border-primary/40 rounded-full flex flex-col items-center justify-center bg-black/40 backdrop-blur-sm">
                                        ...
                                        <p className="text-xl font-black text-primary mt-4 uppercase tracking-[0.3em]">VALIDADO</p>
                                    </div>
                                </motion.div>
                            )}
                        </AnimatePresence>
                        ...
                        <div className="p-8 md:p-10 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/60">Archivo Central de Datos</span>
                            </div>
                            <Badge variant="outline" className="border-primary/20 text-primary text-[8px] font-black px-4 py-1.5 rounded-lg uppercase bg-primary/5 shadow-glow-sm">Confidencial</Badge>
                        </div>
                        ...
                        <div className="p-8 md:p-12 space-y-16">
                            ...
                            <div className="p-10 rounded-[3rem] bg-primary/5 border border-primary/20 shadow-inner relative overflow-hidden group">
                                ...
                                <h4 className="text-[10px] font-black uppercase tracking-[0.6em] text-primary mb-6 flex items-center gap-3">
                                    <CheckCircle className="h-4 w-4" /> Dictamen de Viabilidad Profesional
                                </h4>
                        ...
                        <CardFooter className="p-10 border-t border-white/5 bg-white/[0.01] flex flex-col md:flex-row justify-between items-center gap-6">
                            <div className="flex items-center gap-4 text-[9px] font-black uppercase tracking-[0.4em] text-white/20">
                                <Activity className="h-4 w-4 animate-pulse text-emerald-500" /> INTEGRIDAD VERIFICADA
                            </div>
                            <div className="flex items-center gap-8">
                                <div className="text-center">
                                    <div className="w-32 h-[1px] bg-white/20 mb-2" />
                                    <p className="text-[7px] font-bold text-white/30 uppercase">Firma del Director</p>
                                </div>
                                <div className="text-center">
                                    <div className="w-32 h-[1px] bg-white/20 mb-2" />
                ...
                <div className="lg:col-span-4 space-y-8">
                    <Card className="glass-card border-none p-10 rounded-[2.5rem] bg-primary text-white relative overflow-hidden shadow-glow group">
                        ...
                        <Button variant="secondary" className="w-full h-14 rounded-2xl bg-white text-primary font-black uppercase text-[10px] tracking-widest shadow-2xl relative z-10">
                            SINCRONIZAR REGISTROS <RefreshCw className="ml-3 h-4 w-4" />
                        </Button>
                    </Card>
                    ...
                    <Card className="glass-card border-none bg-white/[0.01] rounded-[2.5rem] p-8 border border-white/5">
                        <CardHeader className="p-0 mb-6">
                            <CardTitle className="text-[10px] font-black uppercase tracking-[0.4em] text-white/40 flex items-center gap-3 italic">
                                <Lock className="h-4 w-4" /> Protección de Datos
                            </CardTitle>
                        </CardHeader>
                        <div className="space-y-4 text-[9px] font-bold uppercase tracking-widest text-white/20">
                            ...
                            <div className="flex justify-between border-b border-white/5 pb-2"><span>Inmutabilidad:</span> <span className="text-white/60">Registro Sellado</span></div>
